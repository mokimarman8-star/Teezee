...
public final class e implements i9.l {
    public static final i9.r d = new i9.r() { // from class: s9.d
        @Override // i9.r
    ...
    private final com.google.android.exoplayer2.util.d0 b = new com.google.android.exoplayer2.util.d0(16384);
    private boolean c;

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ i9.l[] e() {
        return new i9.l[]{new e()};
    }
    ...
    public boolean c(i9.m mVar) {
        ...
        while (true) {
            ...
            if (J == 44096 || J == 44097) {
                ...
                int e = com.google.android.exoplayer2.audio.c.e(d0Var.d(), J);
                if (e == -1) {
                    return false;
                }
                mVar.advancePeekPosition(e - 7);
            } else {
                mVar.resetPeekPosition();
                i3++;
                if (i3 - i >= 8192) {
    ...
    public int d(i9.m mVar, i9.a0 a0Var) {
        int read = mVar.read(this.b.d(), 0, 16384);
        if (read == -1) {
            return -1;
        }
        this.b.P(0);
