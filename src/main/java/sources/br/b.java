...
public final class b extends RecyclerView.r {
    ...
    public b(float f, br.a aVar, boolean z) {
    ...
    public /* synthetic */ b(float f, br.a aVar, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final void g(LinearLayoutManager linearLayoutManager, int i2, boolean z, boolean z2) {
        Intrinsics.h(linearLayoutManager, "manager");
        if (z) {
            View findViewByPosition = linearLayoutManager.findViewByPosition(i2);
            if (z2) {
                f(linearLayoutManager.getItemCount(), i2, i2);
                return;
            }
            boolean d = d(findViewByPosition);
            a.a.f(wf.a.a, j, "firstView " + findViewByPosition + " export " + d + " count " + linearLayoutManager.getItemCount(), false, 4, (Object) null);
            if (d) {
                f(linearLayoutManager.getItemCount(), i2, i2);
            }
        }
    ...
    public final void i(LinearLayoutManager linearLayoutManager, boolean z) {
        ...
        if (!d(linearLayoutManager.findViewByPosition(findFirstVisibleItemPosition)) && this.e != ExposureType.NEST_HORIZONTAL) {
            findFirstVisibleItemPosition++;
        }
        if (!d(linearLayoutManager.findViewByPosition(findLastVisibleItemPosition)) && this.e != ExposureType.NEST_HORIZONTAL) {
            findLastVisibleItemPosition--;
        }
        if (this.f == 0 && this.g == 0) {
            f(linearLayoutManager.getItemCount(), findFirstVisibleItemPosition, findLastVisibleItemPosition);
            this.f = findFirstVisibleItemPosition;
            this.g = findLastVisibleItemPosition;
            return;
        }
        if (z) {
            k(linearLayoutManager.getItemCount(), this.f, findFirstVisibleItemPosition - 1);
            f(linearLayoutManager.getItemCount(), this.g + 1, findLastVisibleItemPosition);
        } else {
            k(linearLayoutManager.getItemCount(), findLastVisibleItemPosition + 1, this.g);
            f(linearLayoutManager.getItemCount(), findFirstVisibleItemPosition, this.f - 1);
        }
        this.f = findFirstVisibleItemPosition;
        this.g = findLastVisibleItemPosition;
    }
