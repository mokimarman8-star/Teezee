...
public class ZipOutputStream extends FilterOutputStream {
    ...
    protected static byte[] toDosTime(long j) {
        return new Date(j).getYear() + 1900 < 1980 ? DOS_TIME_MIN : ZipLong.getBytes(((r2 - 80) << 25) | ((r0.getMonth() + 1) << 21) | (r0.getDate() << 16) | (r0.getHours() << 11) | (r0.getMinutes() << 5) | (r0.getSeconds() >> 1));
    }
    ...
    public void write(int i) throws IOException {
        write(new byte[]{(byte) (i & BYTE_MASK)}, 0, 1);
    }
