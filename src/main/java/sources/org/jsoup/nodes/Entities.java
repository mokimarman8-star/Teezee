...
public abstract class Entities {
    ...
    private static void b(Appendable appendable, EscapeMode escapeMode, int i) {
        ...
        if (nameForCodepoint != HttpUrl.FRAGMENT_ENCODE_SET) {
    ...
    public static void h(EscapeMode escapeMode, String str, int i) {
        ...
        while (!aVar.r()) {
            String k = aVar.k('=');
            aVar.a();
            int parseInt = Integer.parseInt(aVar.m(a), 36);
            char q = aVar.q();
            aVar.a();
            if (q == ',') {
            ...
            aVar.a();
            escapeMode.nameKeys[i3] = k;
            escapeMode.codeVals[i3] = parseInt;
            escapeMode.codeKeys[parseInt2] = parseInt;
            escapeMode.nameVals[parseInt2] = k;
            if (i2 != -1) {
                b.put(k, new String(new int[]{parseInt, i2}, 0, 2));
            }
            i3++;
        }
        org.jsoup.helper.d.e(i3 == i, "Unexpected count of entities loaded");
    }
}
