        ...
        if (webResourceRequest != null) {
            ...
            if (url != null) {
                ...
                if (uri != null && !Intrinsics.c(uri, "yy://__QUEUE_MESSAGE__")) {
                    ...
                    if (h != null) {
                        h.a.f("DR_WebviewRenderDynamicFileLoader", "<interceptRequest> url:" + uri + " pageData is null return");
                        return null;
                    }
                    ...
                    if (fileData == null) {
                        ...
                        h.a.f("DR_WebviewRenderDynamicFileLoader", "<interceptRequest> url:" + uri + " fileData is null return");
                        return null;
                    }
                    ...
                    if (Intrinsics.c(fileData.getMimeType(), "text/html") && this.c.getHtmlUseRemote() && com.transsion.lib_web.download_render.utils.d.a.a()) {
                        ...
                        h.a.a("DR_WebviewRenderDynamicFileLoader", "<interceptRequest> url:" + uri + " is html use remote");
                        return null;
                    }
                    if (fileData.getFileOperateStatus$lib_web_release() != FileOperateStatus.NONE) {
                        aVar.f(this.c.getOriginUrl());
                        h.a.f("DR_WebviewRenderDynamicFileLoader", "<interceptRequest> url:" + uri + " fileOperateStatus:" + fileData.getFileOperateStatus$lib_web_release().getType() + " unNormal return");
                        return null;
                    }
                    ...
                    if (fileLocalPath$lib_web_release == null) {
                        ...
                        h.a.f("DR_WebviewRenderDynamicFileLoader", "<interceptRequest> url:" + uri + " fileLocalPath is null return");
                        return null;
                    }
                    File file = new File(fileLocalPath$lib_web_release);
                    if (!file.exists()) {
                        aVar.g(this.c.getOriginUrl());
                        h.a.f("DR_WebviewRenderDynamicFileLoader", "<interceptRequest> url:" + uri + " file:" + file.getAbsoluteFile() + " is not exist return");
                        return null;
                    }
                    ...
                    h.a.a("DR_WebviewRenderDynamicFileLoader", "<interceptRequest> url:" + uri + ", mimeType:" + mimeType + ", length:" + file.length() + ", file:" + file.getAbsoluteFile() + " exist");
