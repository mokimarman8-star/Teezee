...
public final class SegmentedByteString {
    ...
    public static final String toHexString(byte b) {
        return StringsKt.B(new char[]{ByteString.getHEX_DIGIT_CHARS()[(b >> 4) & 15], ByteString.getHEX_DIGIT_CHARS()[b & 15]});
    }
