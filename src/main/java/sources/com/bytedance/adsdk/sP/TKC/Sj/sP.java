...
public class sP extends sef<Float, Float> {
    public sP(List<com.bytedance.adsdk.sP.Jcg.Sj<Float>> list) {
        super(list);
    }

    @Override // com.bytedance.adsdk.sP.TKC.Sj.Fmk
    public com.bytedance.adsdk.sP.Sj.sP.Sj<Float, Float> Sj() {
        return new com.bytedance.adsdk.sP.Sj.sP.EjP(this.Sj);
    }
