    ...
    public static class Builder {
        ...
        private GradientDrawable getGradientDrawable() {
            ...
            if (f3 != null && this.gradientCenterY != null) {
                gradientDrawable.setGradientCenter(f3.floatValue(), this.gradientCenterY.floatValue());
            }
            ...
            if (this.hasSetPadding) {
                if (Build.VERSION.SDK_INT >= 29) {
                    ...
                    a.a(gradientDrawable, rect.left, rect.top, rect.right, rect.bottom);
                } else {
                    try {
            ...
            if (f5 != null && this.sizeHeight != null) {
                gradientDrawable.setSize(f5.intValue(), this.sizeHeight.intValue());
            }
            ...
            if (f6 != null && f6.floatValue() > 0.0f) {
                ...
                if (arrayList.size() > 0) {
                    ...
                    int i3 = 0;
                    while (it.hasNext()) {
                        iArr[i3] = new int[]{((Integer) it.next()).intValue()};
            ...
            if (arrayList3.size() > 0) {
                ...
                int i4 = 0;
                while (it2.hasNext()) {
                    iArr3[i4] = new int[]{((Integer) it2.next()).intValue()};
