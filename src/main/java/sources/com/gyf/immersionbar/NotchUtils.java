    ...
    */
    public static int getNotchHeight(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= 28 && displayCutout != null) {
            return activity.getResources().getConfiguration().orientation == 1 ? androidx.window.layout.j.a(displayCutout) : i.a(displayCutout) == 0 ? androidx.window.layout.g.a(displayCutout) : i.a(displayCutout);
        }
