...
abstract class h {
    ...
    static String c(String str, String str2, String str3, String str4, int i, String str5, String str6) {
        HashMap hashMap = new HashMap();
    ...
    static String d(int i, String str, int i2, long j, long j2, boolean z, int i3, String str2, String str3) {
        HashMap hashMap = new HashMap();
    ...
    static String e(String str, String str2, boolean z) {
        HashMap hashMap = new HashMap();
