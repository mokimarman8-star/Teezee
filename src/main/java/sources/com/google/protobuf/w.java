...
final class w extends c implements y.g, RandomAccess, c1 {
    ...
    private w(int[] iArr, int i, boolean z) {
        super(z);
        this.array = iArr;
        this.size = i;
    }
    ...
    public y.g mutableCopyWithCapacity(int i) {
        if (i >= this.size) {
            return new w(Arrays.copyOf(this.array, i), this.size, true);
        }
