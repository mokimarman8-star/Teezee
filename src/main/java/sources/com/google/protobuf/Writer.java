...
interface Writer {
    ...
    @Deprecated
    void writeGroup(int i, Object obj, i1 i1Var) throws IOException;

    @Deprecated
    void writeGroupList(int i, List<?> list) throws IOException;

    @Deprecated
    void writeGroupList(int i, List<?> list, i1 i1Var) throws IOException;
    ...
    <K, V> void writeMap(int i, m0.b bVar, Map<K, V> map) throws IOException;

    void writeMessage(int i, Object obj) throws IOException;

    void writeMessage(int i, Object obj, i1 i1Var) throws IOException;

    void writeMessageList(int i, List<?> list) throws IOException;

    void writeMessageList(int i, List<?> list, i1 i1Var) throws IOException;
