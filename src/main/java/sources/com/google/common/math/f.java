...
public abstract class f {
    ...
    static final long[] b = {1, 10, 100, 1000, HttpClientConfig.DEFAULT_CONNECT_TIMEOUT, 100000, 1000000, 10000000, 100000000, C.NANOS_PER_SECOND, 10000000000L, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    ...
    static final int[] e = {h1.READ_DONE, h1.READ_DONE, h1.READ_DONE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] f = {h1.READ_DONE, h1.READ_DONE, h1.READ_DONE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    public static long a(long j, long j2) {
        long j3 = j + j2;
        g.c(((j ^ j2) < 0) | ((j ^ j3) >= 0), "checkedAdd", j, j2);
        return j3;
    }
    ...
    public static long b(long j, long j2) {
        ...
        g.c(numberOfLeadingZeros >= 64, "checkedMultiply", j, j2);
        g.c((j >= 0) | (j2 != Long.MIN_VALUE), "checkedMultiply", j, j2);
        long j3 = j * j2;
        g.c(j == 0 || j3 / j == j2, "checkedMultiply", j, j2);
        return j3;
    }
    ...
    public static long d(long j, long j2) {
        g.e("a", j);
        g.e(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, j2);
        if (j == 0) {
            return j2;
        }
        if (j2 == 0) {
