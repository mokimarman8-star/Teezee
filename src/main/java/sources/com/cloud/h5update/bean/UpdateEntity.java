...
public final /* data */ class UpdateEntity {
    ...
    public UpdateEntity(String str, String str2, String str3, List<PreloadResource> list, Integer num, Long l) {
    ...
    public /* synthetic */ UpdateEntity(String str, String str2, String str3, List list, Integer num, Long l, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : str, (i & 2) != 0 ? null : str2, (i & 4) != 0 ? null : str3, (i & 8) != 0 ? null : list, (i & 16) != 0 ? null : num, (i & 32) != 0 ? null : l);
    }

    public static /* synthetic */ UpdateEntity copy$default(UpdateEntity updateEntity, String str, String str2, String str3, List list, Integer num, Long l, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        Integer num2 = num;
        if ((i & 32) != 0) {
            l = updateEntity.version;
        }
        return updateEntity.copy(str, str4, str5, list2, num2, l);
    }
