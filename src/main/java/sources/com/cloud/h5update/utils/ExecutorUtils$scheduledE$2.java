...
final class ExecutorUtils$scheduledE$2 extends Lambda implements Function0<ScheduledThreadPoolExecutor> {
    ...
    public static final Thread m49invoke$lambda0(final Runnable runnable) {
        AtomicInteger atomicInteger;
        StringBuilder sb = new StringBuilder();
        sb.append("SCHEDULED ");
        atomicInteger = ExecutorUtils.i;
        sb.append(atomicInteger.incrementAndGet());
        return ThreadsKt.b(false, false, (ClassLoader) null, sb.toString(), 1, new Function0<Unit>() { // from class: com.cloud.h5update.utils.ExecutorUtils$scheduledE$2$1$1
    ...
    public final ScheduledThreadPoolExecutor invoke() {
        return new ScheduledThreadPoolExecutor(1, new ThreadFactory() { // from class: com.cloud.h5update.utils.e
            ...
            public final Thread newThread(Runnable runnable) {
                Thread m49invoke$lambda0;
                m49invoke$lambda0 = ExecutorUtils$scheduledE$2.m49invoke$lambda0(runnable);
