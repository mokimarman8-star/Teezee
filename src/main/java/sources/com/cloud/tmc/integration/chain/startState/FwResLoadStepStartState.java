...
public final class FwResLoadStepStartState implements ChainState {
    ...
    */
    ...
    public FwResLoadStepStartState(Bundle bundle) {
    ...
    public /* synthetic */ FwResLoadStepStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
