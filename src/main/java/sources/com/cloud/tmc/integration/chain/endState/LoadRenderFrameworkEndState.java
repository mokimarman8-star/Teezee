...
public final class LoadRenderFrameworkEndState implements ChainState {
    ...
    */
    ...
    public LoadRenderFrameworkEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ LoadRenderFrameworkEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
