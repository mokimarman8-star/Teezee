...
public final class FwResInfoUpdateStepStartState implements ChainState {
    ...
    */
    ...
    public FwResInfoUpdateStepStartState(Bundle bundle) {
    ...
    public /* synthetic */ FwResInfoUpdateStepStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
