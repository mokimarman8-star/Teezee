...
public final /* data */ class WebViewStore extends BaseBean {
    ...
    */
    ...
    public WebViewStore(HashMap<String, BridgeCallback> hashMap) {
        Intrinsics.h(hashMap, "onDownloads");
        this.onDownloads = hashMap;
    }

    public /* synthetic */ WebViewStore(HashMap hashMap, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? new HashMap() : hashMap);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ WebViewStore copy$default(WebViewStore webViewStore, HashMap hashMap, int i, Object obj) {
        if ((i & 1) != 0) {
