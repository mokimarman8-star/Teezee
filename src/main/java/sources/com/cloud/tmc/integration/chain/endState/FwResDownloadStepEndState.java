...
public final class FwResDownloadStepEndState implements ChainState {
    ...
    */
    ...
    public FwResDownloadStepEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ FwResDownloadStepEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
