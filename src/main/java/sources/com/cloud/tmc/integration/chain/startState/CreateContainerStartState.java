...
public final class CreateContainerStartState implements ChainState {
    ...
    */
    ...
    public CreateContainerStartState(Bundle bundle) {
    ...
    public /* synthetic */ CreateContainerStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
