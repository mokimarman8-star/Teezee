...
public final /* data */ class OffScreenRender extends BaseBean {
    ...
    public OffScreenRender(boolean z, int i, float f) {
        this.enable = z;
        this.maxSize = i;
        this.grayScale = f;
    }

    public /* synthetic */ OffScreenRender(boolean z, int i, float f, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, i, (i2 & 4) != 0 ? 0.0f : f);
    }

    public static /* synthetic */ OffScreenRender copy$default(OffScreenRender offScreenRender, boolean z, int i, float f, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            z = offScreenRender.enable;
        }
        if ((i2 & 2) != 0) {
            i = offScreenRender.maxSize;
        }
        if ((i2 & 4) != 0) {
            f = offScreenRender.grayScale;
        }
        return offScreenRender.copy(z, i, f);
    }
    ...
    public int hashCode() {
        ...
        return (((r0 * 31) + this.maxSize) * 31) + Float.floatToIntBits(this.grayScale);
    }
