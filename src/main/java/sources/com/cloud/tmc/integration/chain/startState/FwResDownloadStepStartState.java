...
public final class FwResDownloadStepStartState implements ChainState {
    ...
    */
    ...
    public FwResDownloadStepStartState(Bundle bundle) {
    ...
    public /* synthetic */ FwResDownloadStepStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
