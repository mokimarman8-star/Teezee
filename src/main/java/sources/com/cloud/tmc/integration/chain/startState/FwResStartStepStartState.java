...
public final class FwResStartStepStartState implements ChainState {
    ...
    */
    ...
    public FwResStartStepStartState(Bundle bundle) {
    ...
    public /* synthetic */ FwResStartStepStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
