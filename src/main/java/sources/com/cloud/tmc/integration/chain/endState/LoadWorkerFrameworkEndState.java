...
public final class LoadWorkerFrameworkEndState implements ChainState {
    ...
    */
    ...
    public LoadWorkerFrameworkEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ LoadWorkerFrameworkEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
