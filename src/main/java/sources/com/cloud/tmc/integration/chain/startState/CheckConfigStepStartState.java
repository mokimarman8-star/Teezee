...
public final class CheckConfigStepStartState implements ChainState {
    ...
    */
    ...
    public CheckConfigStepStartState(Bundle bundle) {
    ...
    public /* synthetic */ CheckConfigStepStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
