...
public final class FwResStartStepEndState implements ChainState {
    ...
    */
    ...
    public FwResStartStepEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ FwResStartStepEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
