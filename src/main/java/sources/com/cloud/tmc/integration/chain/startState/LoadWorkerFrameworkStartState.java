...
public final class LoadWorkerFrameworkStartState implements ChainState {
    ...
    */
    ...
    public LoadWorkerFrameworkStartState(Bundle bundle) {
    ...
    public /* synthetic */ LoadWorkerFrameworkStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
