...
final class WorkerWarmupManager$warmup$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    WorkerWarmupManager$warmup$1(JSI jsi, Node node, WarmUpCallback warmUpCallback, Continuation<? super WorkerWarmupManager$warmup$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        jsi.registerWorkerReadyListener(new JSI.WorkerReadyListener() { // from class: com.cloud.tmc.integration.performance.worker.a
            public final void onWorkerReady() {
                WorkerWarmupManager$warmup$1.invokeSuspend$lambda$0(node, jsi, warmUpCallback);
            }
        });
        return Unit.a;
    }
