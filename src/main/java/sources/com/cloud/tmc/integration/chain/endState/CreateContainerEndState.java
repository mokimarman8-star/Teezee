...
public final class CreateContainerEndState implements ChainState {
    ...
    */
    ...
    public CreateContainerEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ CreateContainerEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
