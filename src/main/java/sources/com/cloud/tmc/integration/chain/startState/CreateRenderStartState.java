...
public final class CreateRenderStartState implements ChainState {
    ...
    */
    ...
    public CreateRenderStartState(Bundle bundle) {
    ...
    public /* synthetic */ CreateRenderStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
