...
public final /* data */ class RenderWarmup extends BaseBean {
    ...
    public RenderWarmup(boolean z, boolean z2, int i) {
        this.open = z;
        this.lazyLoad = z2;
        this.cacheSize = i;
    }

    public static /* synthetic */ RenderWarmup copy$default(RenderWarmup renderWarmup, boolean z, boolean z2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            z = renderWarmup.open;
        }
        if ((i2 & 2) != 0) {
            z2 = renderWarmup.lazyLoad;
        }
        if ((i2 & 4) != 0) {
            i = renderWarmup.cacheSize;
        }
        return renderWarmup.copy(z, z2, i);
    }
