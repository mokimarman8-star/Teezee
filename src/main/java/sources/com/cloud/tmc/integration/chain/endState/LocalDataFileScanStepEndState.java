...
public final class LocalDataFileScanStepEndState implements ChainState {
    ...
    */
    ...
    public LocalDataFileScanStepEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ LocalDataFileScanStepEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
