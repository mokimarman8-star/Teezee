...
public final class CheckConfigStepEndState implements ChainState {
    ...
    */
    ...
    public CheckConfigStepEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ CheckConfigStepEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
