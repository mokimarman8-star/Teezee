...
public final class LauncherMMkvStorageHelper {
    ...
    public final MMKV getGetLauncherMultiMMKV() {
        if (multiMMKV == null) {
            try {
                ...
                MMKV L = MMKV.L("zeroscreen_sp_file_nametrue", 2, (String) null, (Build.VERSION.SDK_INT >= 24 ? app.createDeviceProtectedStorageContext() : app).getFilesDir().getAbsolutePath() + "/files/mmkv/" + app.getPackageName());
                Intrinsics.g(L, "mmkvWithID(\n            …dir\n                    )");
                multiMMKV = L;
            } catch (Throwable th) {
                TmcLogger.e("getLauncherMultiMMKV error", th);
            }
        }
        MMKV mmkv = multiMMKV;
        if (mmkv != null) {
    ...
    public final void putNewsOptionPopShow(boolean showStatus) {
        try {
            ...
            TmcLogger.e("putSelectLanguage", th);
        }
    }
