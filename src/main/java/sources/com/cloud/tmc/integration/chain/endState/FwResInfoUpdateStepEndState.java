...
public final class FwResInfoUpdateStepEndState implements ChainState {
    ...
    */
    ...
    public FwResInfoUpdateStepEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ FwResInfoUpdateStepEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
