...
public final class FwResLoadStepEndState implements ChainState {
    ...
    */
    ...
    public FwResLoadStepEndState(Bundle bundle) {
        Intrinsics.h(bundle, "dataBundle");
        this.dataBundle = bundle;
    }

    public /* synthetic */ FwResLoadStepEndState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
