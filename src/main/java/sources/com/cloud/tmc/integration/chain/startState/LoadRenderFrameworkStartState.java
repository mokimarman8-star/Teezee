...
public final class LoadRenderFrameworkStartState implements ChainState {
    ...
    */
    ...
    public LoadRenderFrameworkStartState(Bundle bundle) {
    ...
    public /* synthetic */ LoadRenderFrameworkStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
