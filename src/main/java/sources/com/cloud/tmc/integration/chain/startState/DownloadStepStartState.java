...
public final class DownloadStepStartState implements ChainState {
    ...
    */
    ...
    public DownloadStepStartState(Bundle bundle) {
    ...
    public /* synthetic */ DownloadStepStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
