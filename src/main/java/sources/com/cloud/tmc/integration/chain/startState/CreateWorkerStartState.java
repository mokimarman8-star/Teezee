...
public final class CreateWorkerStartState implements ChainState {
    ...
    */
    ...
    public CreateWorkerStartState(Bundle bundle) {
    ...
    public /* synthetic */ CreateWorkerStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
