...
public final class LocalDataFileScanStepStartState implements ChainState {
    ...
    */
    ...
    public LocalDataFileScanStepStartState(Bundle bundle) {
    ...
    public /* synthetic */ LocalDataFileScanStepStartState(Bundle bundle, int i, DefaultConstructorMarker defaultConstructorMarker) {
