...
public interface AdShowEventListener {
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ void click$default(AdShowEventListener adShowEventListener, String str, DownUpPointBean downUpPointBean, String str2, int i, Object obj) {
            if (obj != null) {
        ...
        public static void clickHomePage(AdShowEventListener adShowEventListener, String str) {
            Intrinsics.h(str, "triggerId");
        }

        public static void clickPersonalization(AdShowEventListener adShowEventListener, String str) {
            Intrinsics.h(str, "triggerId");
        }
    }
