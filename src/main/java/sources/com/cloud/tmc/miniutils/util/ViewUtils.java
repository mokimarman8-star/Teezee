...
public class ViewUtils {
    ...
    public static boolean isLayoutRtl() {
        return TextUtils.getLayoutDirectionFromLocale(Build.VERSION.SDK_INT >= 24 ? n0.d.a(androidx.appcompat.app.h.a(Utils.getApp().getResources().getConfiguration()), 0) : Utils.getApp().getResources().getConfiguration().locale) == 1;
    }
