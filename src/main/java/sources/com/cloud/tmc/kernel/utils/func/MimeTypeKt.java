...
@Metadata(d1 = {"\u0000\u001a\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0000\u001a\u0016\u0010\u0007\u001a\u00020\u00012\u0006\u0010\b\u001a\u00020\u00012\u0006\u0010\t\u001a\u00020\n\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"-\u0010\u0002\u001a\u001e\u0012\u0004\u0012\u00020\u0001\u0012\u0004\u0012\u00020\u00010\u0003j\u000e\u0012\u0004\u0012\u00020\u0001\u0012\u0004\u0012\u00020\u0001`\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u000b"}, d2 = {"ALL_MIME_TYPES", "", "MIME_TYPES", "Ljava/util/HashMap;", "Lkotlin/collections/HashMap;", "getMIME_TYPES", "()Ljava/util/HashMap;", "getMimeType", "extension", "isDirectory", "", BuildConfig.LIBRARY_PACKAGE_NAME}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class MimeTypeKt {
    ...
    static {
        ...
        hashMap.put(TmcConstants.START_FROM_PS, "application/postscript");
    ...
    public static final String getMimeType(String str, boolean z) {
        String str2;
        Intrinsics.h(str, "extension");
        if (z) {
            return "";
        }
        if (str.length() > 0) {
            ...
            if (str2 == null) {
                str2 = MIME_TYPES.get(lowerCase);
            }
        } else {
            str2 = ALL_MIME_TYPES;
        }
        return str2 == null ? ALL_MIME_TYPES : str2;
    }
}
