...
public final class AddHomeCustom1PopUpWindowView extends LinearLayout {
    ...
    */
    ...
    public /* synthetic */ AddHomeCustom1PopUpWindowView(Context context, AttributeSet attributeSet, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i & 2) != 0 ? null : attributeSet);
    }

    public static final void OooO00o(IResourceProcessor iResourceProcessor, String str, String str2, AddHomeCustom1PopUpWindowView addHomeCustom1PopUpWindowView, final Function1 function1) {
        Intrinsics.h(addHomeCustom1PopUpWindowView, "this$0");
        final File file = iResourceProcessor != null ? iResourceProcessor.get(str, str2) : null;
        ImageView ivImages = addHomeCustom1PopUpWindowView.getIvImages();
        if (ivImages != null) {
            ivImages.post(new Runnable() { // from class: com.cloud.tmc.miniapp.widget.popupview.a
                @Override // java.lang.Runnable
                public final void run() {
                    AddHomeCustom1PopUpWindowView.OooO00o(function1, file);
                }
            });
        }
    }

    public static final void OooO00o(AddHomeCustom1PopUpWindowView addHomeCustom1PopUpWindowView, View view) {
        Intrinsics.h(addHomeCustom1PopUpWindowView, "this$0");
        addHomeCustom1PopUpWindowView.getClass();
        ViewExtKt.toGone(addHomeCustom1PopUpWindowView);
    }
    ...
    public final void OooO00o(final String str, final String str2, final Function1<? super Drawable, Unit> function1) {
        if (str != null) {
            try {
                ...
                TmcLogger.e("AddHomeCustom1PopUpWind", "requestDrawable failed!", th);
