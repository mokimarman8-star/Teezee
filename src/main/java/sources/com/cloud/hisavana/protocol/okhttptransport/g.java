...
final class g {
    ...
    private final i c;
    private final d d;
    private final com.cloud.hisavana.protocol.okhttptransport.c e;
    ...
    class a implements c {
        ...
        public Response getResponse() {
            return g.this.c.g(this.a, this.b);
        }
    }
    ...
    g(CronetEngine cronetEngine, Executor executor, d dVar, i iVar, com.cloud.hisavana.protocol.okhttptransport.c cVar) {
        this.a = cronetEngine;
        this.b = executor;
        this.d = dVar;
        this.c = iVar;
