...
public final class o extends BaseItemProvider {
    ...
    private final void A(BaseViewHolder baseViewHolder, boolean z) {
        ((ImageView) baseViewHolder.getView(R.id.iv_album_check)).setSelected(z);
    }
    ...
    public int m() {
        return this.e ? R.layout.item_download_res_path_phone_storage_album_save : R.layout.item_download_res_path_phone_storage_album;
    }
