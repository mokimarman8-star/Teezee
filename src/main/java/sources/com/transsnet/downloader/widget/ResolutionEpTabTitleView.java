...
public final class ResolutionEpTabTitleView extends SimplePagerTitleView implements cj.a {
    ...
    public ResolutionEpTabTitleView(Context context) {
        ...
        setPadding(a, 0, a, 0);
        setBackgroundResource(com.transsnet.downloader.R.drawable.selector_download_resolution_bg);
