...
public final class FileManagerTabTitleView extends FrameLayout implements xy.b {
    ...
    public FileManagerTabTitleView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectedColor = androidx.core.content.b.getColor(getContext(), com.tn.lib.widget.R.color.new_text_05);
    }
    ...
    public void onDeselected(int index, int totalCount) {
        this.viewBinding.b.setTextColor(this.normalColor);
        this.viewBinding.b.setBackgroundResource(R.drawable.bg_shape_download_tab_unselected);
        TnTextView tnTextView = this.viewBinding.b;
    ...
    public void onSelected(int index, int totalCount) {
        this.viewBinding.b.setTextColor(this.selectedColor);
        this.viewBinding.b.setBackgroundResource(R.drawable.bg_shape_download_tab_selected);
        TnTextView tnTextView = this.viewBinding.b;
        Context context = getContext();
        Intrinsics.g(context, "getContext(...)");
    ...
    public final void setTitle(final String title) {
        ...
        this.viewBinding.b.setTextAction(new Function0() { // from class: com.transsnet.downloader.widget.z
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                CharSequence e;
                e = FileManagerTabTitleView.e(title);
                return e;
            }
        });
    }
    ...
    public final void setTitle(final String title, int count, int position) {
        ...
        if (position == 1) {
            this.viewBinding.b.setTextAction(new Function0() { // from class: com.transsnet.downloader.widget.a0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    CharSequence f;
                    f = FileManagerTabTitleView.f(FileManagerTabTitleView.this, str);
                    return f;
                }
            });
        } else if (position != 2) {
            this.viewBinding.b.setTextAction(new Function0() { // from class: com.transsnet.downloader.widget.c0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    CharSequence h;
                    h = FileManagerTabTitleView.h(title);
                    return h;
                }
            });
        } else {
            this.viewBinding.b.setTextAction(new Function0() { // from class: com.transsnet.downloader.widget.b0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    CharSequence g;
                    g = FileManagerTabTitleView.g(FileManagerTabTitleView.this, str);
                    return g;
                }
            });
        }
