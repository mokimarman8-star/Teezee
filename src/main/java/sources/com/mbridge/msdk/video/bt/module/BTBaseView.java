...
public abstract class BTBaseView extends FrameLayout {
    ...
    protected static void a(WebView webView, String str, String str2) {
        try {
            ...
            jSONObject.put(TrackingKey.CODE, n);
    ...
    public int findColor(String str) {
        return g0.a(this.a.getApplicationContext(), str, TtmlNode.ATTR_TTS_COLOR);
    }

    public int findDrawable(String str) {
        return g0.a(this.a.getApplicationContext(), str, "drawable");
    }

    public int findID(String str) {
        return g0.a(this.a.getApplicationContext(), str, "id");
    }

    public int findLayout(String str) {
        return g0.a(this.a.getApplicationContext(), str, TtmlNode.TAG_LAYOUT);
    }
