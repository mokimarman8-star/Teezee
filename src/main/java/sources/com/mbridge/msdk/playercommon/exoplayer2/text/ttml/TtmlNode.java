...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C.TIME_UNSET, C.TIME_UNSET, null, null, ANONYMOUS_REGION_ID);
    }
    ...
    private void traverseForText(long j, boolean z, String str, Map<String, SpannableStringBuilder> map) {
        ...
        if (!ANONYMOUS_REGION_ID.equals(this.regionId)) {
            str = this.regionId;
        }
