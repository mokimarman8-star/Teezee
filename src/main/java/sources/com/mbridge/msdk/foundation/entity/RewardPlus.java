...
public class RewardPlus implements Serializable, NoProGuard {
    ...
    private String icon = TtmlNode.ANONYMOUS_REGION_ID;
    private String name = "Virtual Item";
    private String virtualCurrency = TtmlNode.ANONYMOUS_REGION_ID;
    ...
    public static RewardPlus parse(JSONObject jSONObject) {
        ...
        rewardPlus.setVirtualCurrency(jSONObject.optString(VIRTUAL_CURRENCY, TtmlNode.ANONYMOUS_REGION_ID));
        rewardPlus.setIcon(jSONObject.optString(ICON, TtmlNode.ANONYMOUS_REGION_ID));
