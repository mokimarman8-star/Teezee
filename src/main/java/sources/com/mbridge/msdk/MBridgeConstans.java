...
public class MBridgeConstans extends a {
    ...
    public static String FILE_PROVIDE_CUSTOM_PATH = TtmlNode.ANONYMOUS_REGION_ID;
    ...
    public static String OMID_JS_H5_CONTENT = TtmlNode.ANONYMOUS_REGION_ID;
    public static String OMID_JS_H5_URL = TtmlNode.ANONYMOUS_REGION_ID;
    public static String OMID_JS_SERVICE_CONTENT = TtmlNode.ANONYMOUS_REGION_ID;
    public static String OMID_JS_SERVICE_URL = TtmlNode.ANONYMOUS_REGION_ID;
    ...
    public static String DEVELOPER_CUSTOM_PACKAGE = TtmlNode.ANONYMOUS_REGION_ID;
}
