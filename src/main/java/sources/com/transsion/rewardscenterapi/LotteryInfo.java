...
public final /* data */ class LotteryInfo implements Serializable {
    ...
    public /* synthetic */ LotteryInfo(String str, UserLotteryInfo userLotteryInfo, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : str, (i & 2) != 0 ? null : userLotteryInfo);
    }

    public static /* synthetic */ LotteryInfo copy$default(LotteryInfo lotteryInfo, String str, UserLotteryInfo userLotteryInfo, int i, Object obj) {
        if ((i & 1) != 0) {
