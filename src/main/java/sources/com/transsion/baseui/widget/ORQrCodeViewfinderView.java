...
public class ORQrCodeViewfinderView extends ViewfinderView {
    ...
    public ORQrCodeViewfinderView(Context context, AttributeSet attributeSet) {
        ...
        this.mLineColor = obtainStyledAttributes.getColor(R$styleable.ORQrCodeViewfinderView_lineColor, -256);
        this.mScanLineColor[1] = obtainStyledAttributes.getColor(R$styleable.ORQrCodeViewfinderView_cornerColor, -256);
    ...
    protected void a() {
        ...
        q previewSize = ((ViewfinderView) this).k.getPreviewSize();
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (((ViewfinderView) this).b != null) {
            ...
            float width4 = getWidth() / ((ViewfinderView) this).m.a;
            float height2 = getHeight() / ((ViewfinderView) this).m.b;
            if (!((ViewfinderView) this).j.isEmpty()) {
                ((ViewfinderView) this).a.setAlpha(80);
                ((ViewfinderView) this).a.setColor(((ViewfinderView) this).f);
                for (k kVar : ((ViewfinderView) this).j) {
                    canvas.drawCircle((int) (kVar.c() * width4), (int) (kVar.d() * height2), 3.0f, ((ViewfinderView) this).a);
                }
                ((ViewfinderView) this).j.clear();
            }
            if (!((ViewfinderView) this).i.isEmpty()) {
                ((ViewfinderView) this).a.setAlpha(160);
                ((ViewfinderView) this).a.setColor(((ViewfinderView) this).f);
                for (k kVar2 : ((ViewfinderView) this).i) {
                    canvas.drawCircle((int) (kVar2.c() * width4), (int) (kVar2.d() * height2), 6.0f, ((ViewfinderView) this).a);
                }
                List list = ((ViewfinderView) this).i;
                List list2 = ((ViewfinderView) this).j;
                ((ViewfinderView) this).i = list2;
                ((ViewfinderView) this).j = list;
                list2.clear();
            }
        }
