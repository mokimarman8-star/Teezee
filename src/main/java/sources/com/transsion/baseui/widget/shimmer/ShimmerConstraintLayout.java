...
public class ShimmerConstraintLayout extends ConstraintLayout {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            setShimmer(((obtainStyledAttributes.hasValue(R$styleable.ShimmerConstraintLayout_shimmer_colored) && obtainStyledAttributes.getBoolean(R$styleable.ShimmerConstraintLayout_shimmer_colored, false)) ? new a.c() : new a.C0018a()).c(obtainStyledAttributes).a());
