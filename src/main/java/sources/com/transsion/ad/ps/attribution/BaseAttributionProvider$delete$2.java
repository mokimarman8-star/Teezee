...
final class BaseAttributionProvider$delete$2 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    final /* synthetic */ AttributionPoint $attributionPoint;
    int label;
    final /* synthetic */ BaseAttributionProvider this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    BaseAttributionProvider$delete$2(BaseAttributionProvider baseAttributionProvider, AttributionPoint attributionPoint, Continuation<? super BaseAttributionProvider$delete$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (f.a(attributionPoint, this) == f2) {
                return f2;
            }
        } else {
            if (i != 1) {
