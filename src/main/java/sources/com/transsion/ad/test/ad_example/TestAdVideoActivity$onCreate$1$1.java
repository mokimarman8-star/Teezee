...
final class TestAdVideoActivity$onCreate$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ TestAdVideoActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TestAdVideoActivity$onCreate$1$1(TestAdVideoActivity testAdVideoActivity, Continuation<? super TestAdVideoActivity$onCreate$1$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            AbsAdBidding absAdBidding2 = this.this$0.videoManager;
            if (absAdBidding2 == null) {
                Intrinsics.y("videoManager");
                absAdBidding2 = null;
            }
            absAdBidding2.L0("MBVideoTestId");
            AbsAdBidding absAdBidding3 = this.this$0.videoManager;
            if (absAdBidding3 == null) {
                Intrinsics.y("videoManager");
                absAdBidding3 = null;
            }
            absAdBidding3.J0((Map) null);
            AbsAdBidding absAdBidding4 = this.this$0.videoManager;
            if (absAdBidding4 == null) {
                Intrinsics.y("videoManager");
                absAdBidding4 = null;
            }
            absAdBidding4.I0(this.this$0);
            AbsAdBidding absAdBidding5 = this.this$0.videoManager;
            ...
            AbsAdBidding absAdBidding6 = this.this$0.videoManager;
