...
final class PaymentService$paymentOrderCreate4Gp$1 extends ContinuationImpl {
    int label;
    /* synthetic */ Object result;
    final /* synthetic */ PaymentService this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PaymentService$paymentOrderCreate4Gp$1(PaymentService paymentService, Continuation<? super PaymentService$paymentOrderCreate4Gp$1> continuation) {
        super(continuation);
