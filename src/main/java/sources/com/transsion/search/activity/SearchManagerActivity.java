...
public final class SearchManagerActivity extends BaseNewActivity<a> {
    ...
    private final void D0() {
        ...
        Fragment a = i != 2 ? i != 3 ? SearchUploadWorkFragment.INSTANCE.a(i) : SearchSubjectFragment.INSTANCE.a(stringExtra, this.keyWord, this.backExitSearch) : SearchUploadGroupFragment.INSTANCE.a(i);
        Companion companion = INSTANCE;
        Fragment fragment = this.mFragment;
        companion.a("fragment = " + (fragment != null ? fragment.getClass().getSimpleName() : null));
        p.s(R$id.fl_content, a);
        this.mFragment = a;
        p.j();
    }
