...
public final class ShortTvEpisodeListAdapter$EpisodeViewHolder extends BaseViewHolder {
    ...
    public ShortTvEpisodeListAdapter$EpisodeViewHolder(ShortTvEpisodeItemView shortTvEpisodeItemView) {
        super(shortTvEpisodeItemView);
        Intrinsics.h(shortTvEpisodeItemView, "view");
        this.view = shortTvEpisodeItemView;
    }
}
