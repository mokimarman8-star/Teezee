...
public final /* data */ class CommentListBean implements Serializable {
    ...
    public static /* synthetic */ CommentListBean copy$default(CommentListBean commentListBean, List list, Pager pager, int i, Object obj) {
        if ((i & 1) != 0) {
