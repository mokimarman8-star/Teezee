...
public final class CommentHolder extends BaseViewHolder implements h0 {
    ...
    public static final void k(p6.a aVar, CommentHolder commentHolder, View view) {
        ...
        Context context = ((RecyclerView.a0) commentHolder).itemView.getContext();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void m(CommentHolder commentHolder, p6.a aVar, g0 g0Var, View view) {
        if (!yg.l.a.e()) {
    ...
    public void d(int position, final p6.a info, final g0 clickListener) {
        ...
        if (info instanceof CommentBean) {
            ...
            ((RecyclerView.a0) this).itemView.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.postdetail.comment.q
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    CommentHolder.n(g0.this, info, view2);
                }
            });
            ((RecyclerView.a0) this).itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.transsion.postdetail.comment.r
                @Override // android.view.View.OnLongClickListener
                public final boolean onLongClick(View view2) {
                    boolean o;
                    o = CommentHolder.o(g0.this, info, view2);
                    return o;
                }
            });
            ShapeableImageView shapeableImageView2 = this.mCommentCover;
            if (shapeableImageView2 != null) {
                shapeableImageView2.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.postdetail.comment.s
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        CommentHolder.k(info, this, view2);
                    }
                });
            }
        }
