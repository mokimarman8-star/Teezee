...
@DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getPostSubPageList$1", f = "RoomPostViewModel.kt", l = {488}, m = "invokeSuspend")
/* loaded from: /home/user/Teezee-git/app_source/classes6.dex */
final class RoomPostViewModel$getPostSubPageList$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getPostSubPageList$1$1", f = "RoomPostViewModel.kt", l = {479, 481, 483}, m = "invokeSuspend")
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.b, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.L$0 = bVar;
                this.label = 1;
                obj = c.a.a(M, str, str2, i2, str3, null, this, 16, null);
                if (obj == f) {
                    return f;
                }
            } else {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getPostSubPageList$1$2", f = "RoomPostViewModel.kt", l = {487}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RoomPostViewModel$getPostSubPageList$1(boolean z, String str, boolean z2, RoomPostViewModel roomPostViewModel, String str2, int i, String str3, Continuation<? super RoomPostViewModel$getPostSubPageList$1> continuation) {
        super(2, continuation);
        this.$isFirstLoad = z;
        this.$tabId = str;
        this.$isRefresh = z2;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            if (this.$isFirstLoad) {
                String string = com.transsion.baselib.report.launch.b.a.b().getString("post_sub_page_cache_" + this.$tabId, (String) null);
