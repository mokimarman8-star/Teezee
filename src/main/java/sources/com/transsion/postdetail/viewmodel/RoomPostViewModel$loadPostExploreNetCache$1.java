...
final class RoomPostViewModel$loadPostExploreNetCache$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    private /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ RoomPostViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RoomPostViewModel$loadPostExploreNetCache$1(RoomPostViewModel roomPostViewModel, Continuation<? super RoomPostViewModel$loadPostExploreNetCache$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        String string2 = bVar.b().getString("room_cache_data", BuildConfig.FLAVOR);
        if (string2 != null && string2.length() != 0) {
            a.a.f(wf.a.a, "RoomPostVM", "loadPostExploreNetCache, 有手动缓存不处理网络缓存", false, 4, (Object) null);
            return Unit.a;
        }
        ...
        try {
            ...
            str = null;
            string = bVar.b().getString("post_explore_net_cache", (String) null);
        } catch (Throwable th2) {
        ...
        if (string != null && string.length() != 0) {
            ...
            a.a.f(aVar, "RoomPostVM", "loadPostExploreNetCache, 网络未曝光缓存-hase cache,show cache,firstContent:" + str, false, 4, (Object) null);
            b0Var = roomPostViewModel.d;
            b0Var.n(postSubjectBean);
            Result.constructor-impl(Unit.a);
            return Unit.a;
        }
        a.a.f(wf.a.a, "RoomPostVM", "loadPostExploreNetCache, 没有网络缓存", false, 4, (Object) null);
        Result.constructor-impl(Unit.a);
        return Unit.a;
    }
}
