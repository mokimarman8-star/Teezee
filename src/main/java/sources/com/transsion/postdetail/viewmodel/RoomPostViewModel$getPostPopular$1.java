...
@DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getPostPopular$1", f = "RoomPostViewModel.kt", l = {338}, m = "invokeSuspend")
/* loaded from: /home/user/Teezee-git/app_source/classes6.dex */
final class RoomPostViewModel$getPostPopular$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getPostPopular$1$1", f = "RoomPostViewModel.kt", l = {329, 331, 333}, m = "invokeSuspend")
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.b, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(RoomPostViewModel roomPostViewModel, String str, String str2, int i, boolean z, Continuation<? super AnonymousClass1> continuation) {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.RoomPostViewModel$getPostPopular$1$2", f = "RoomPostViewModel.kt", l = {337}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RoomPostViewModel$getPostPopular$1(RoomPostViewModel roomPostViewModel, String str, String str2, int i, boolean z, boolean z2, Continuation<? super RoomPostViewModel$getPostPopular$1> continuation) {
        super(2, continuation);
        this.this$0 = roomPostViewModel;
        this.$groupId = str;
        this.$page = str2;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.t(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.this$0, this.$groupId, this.$page, this.$perPage, this.$with, null)), y0.b()), new AnonymousClass2(null));
