...
final class CommentViewModel$deleteComment$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.viewmodel.CommentViewModel$deleteComment$1$1", f = "CommentViewModel.kt", l = {134, 136, 139}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CommentViewModel$deleteComment$1(String str, CommentViewModel commentViewModel, String str2, Continuation<? super CommentViewModel$deleteComment$1> continuation) {
        super(2, continuation);
        this.$topicType = str;
        this.this$0 = commentViewModel;
        this.$commentId = str2;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.t(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.$topicType, this.this$0, this.$commentId, null)), y0.b()), new AnonymousClass2(this.this$0, null));
