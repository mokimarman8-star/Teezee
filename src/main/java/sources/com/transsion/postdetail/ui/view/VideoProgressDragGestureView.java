...
public final class VideoProgressDragGestureView extends View {
    ...
    public VideoProgressDragGestureView(Context context, AttributeSet attributeSet, int i) {
