...
public final class PublishDetailSubjectView extends ConstraintLayout {
    ...
    public PublishDetailSubjectView(Context context, AttributeSet attributeSet, int i) {
    ...
    private final void k() {
        ...
        if (downloadView != null) {
            downloadView.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.postdetail.ui.view.s1
        ...
        if (constraintLayout != null) {
            constraintLayout.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.postdetail.ui.view.t1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public static final void l(PublishDetailSubjectView publishDetailSubjectView, View view) {
        ...
        if (publishDetailSubjectView.getContext() instanceof FragmentActivity) {
            ...
            if (DownloadManagerApi.x0(a, subjectId2, resourceId, (postSubjectItem3 == null || (subject4 = postSubjectItem3.getSubject()) == null) ? false : subject4.isSeries(), false, 8, (Object) null)) {
                ...
                DownloadManagerApi.z0(a2, subjectId, context, publishDetailSubjectView.pageName, (String) null, 8, (Object) null);
                return;
            }
            ...
            if (postSubjectItem5 != null && (subject2 = postSubjectItem5.getSubject()) != null) {
                ...
                if (subjectType != null && subjectType.intValue() == value) {
                    ...
                    FragmentActivity context2 = publishDetailSubjectView.getContext();
                    Intrinsics.f(context2, "null cannot be cast to non-null type androidx.fragment.app.FragmentActivity");
                    FragmentActivity fragmentActivity = context2;
                    String str2 = publishDetailSubjectView.pageName;
            ...
            FragmentActivity context3 = publishDetailSubjectView.getContext();
    ...
    public static final void m(PublishDetailSubjectView publishDetailSubjectView, View view) {
        Function0 function0;
        if (com.transsion.baseui.util.c.a.a(view.getId(), 2000L) || (function0 = publishDetailSubjectView.mOnItemClick) == null) {
            return;
        }
    }
    ...
    private final void o() {
        ...
        Function1 function1 = new Function1() { // from class: com.transsion.postdetail.ui.view.u1
            public final Object invoke(Object obj) {
                Unit p;
                p = PublishDetailSubjectView.p(PublishDetailSubjectView.this, (AddToDownloadEvent) obj);
                return p;
            }
        };
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit p(PublishDetailSubjectView publishDetailSubjectView, AddToDownloadEvent addToDownloadEvent) {
        String subjectId;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ void showData$default(PublishDetailSubjectView publishDetailSubjectView, PostSubjectItem postSubjectItem, String str, boolean z, Function0 function0, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        if ((i & 8) != 0) {
        ...
        publishDetailSubjectView.showData(postSubjectItem, str, z, function0);
    }
