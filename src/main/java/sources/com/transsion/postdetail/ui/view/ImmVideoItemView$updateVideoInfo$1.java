...
final class ImmVideoItemView$updateVideoInfo$1 extends SuspendLambda implements Function2<kotlinx.coroutines.n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.postdetail.ui.view.ImmVideoItemView$updateVideoInfo$1$1", f = "ImmVideoItemView.kt", l = {415}, m = "invokeSuspend")
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                if (media != null && (firstFrame = media.getFirstFrame()) != null && (url = firstFrame.getUrl()) != null) {
                    Context context = this.this$0.viewBinding.i.getContext();
    ...
    static final class a implements kotlinx.coroutines.flow.b {
        ...
        public final Object emit(Bitmap bitmap, Continuation continuation) {
            this.a.viewBinding.i.setImageBitmap(bitmap);
            return Unit.a;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ImmVideoItemView$updateVideoInfo$1(PostSubjectItem postSubjectItem, ImmVideoItemView immVideoItemView, Continuation<? super ImmVideoItemView$updateVideoInfo$1> continuation) {
        super(2, continuation);
        this.$item = postSubjectItem;
        this.this$0 = immVideoItemView;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.t(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.$item, this.this$0, null)), kotlinx.coroutines.y0.b()), new AnonymousClass2(null));
