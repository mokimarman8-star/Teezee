...
public class RoomPostSubFragment extends RoomPostBaseFragment {
    ...
    private final Lazy trendingImageRoomsViewModel = FragmentViewModelLazyKt.a(this, Reflection.b(ep.j.class), new Function0<androidx.lifecycle.x0>() { // from class: com.transsion.postdetail.ui.fragment.RoomPostSubFragment$special$$inlined$activityViewModels$default$1
        ...
        public final androidx.lifecycle.x0 m119invoke() {
    ...
    public static final class Companion {
        ...
        public final RoomPostSubFragment a(String str, RoomTabItem roomTabItem, int i) {
            Intrinsics.h(roomTabItem, "item");
            RoomPostSubFragment roomPostSubFragment = new RoomPostSubFragment();
            roomPostSubFragment.setArguments(androidx.core.os.d.b(new Pair[]{TuplesKt.a(RoomPostSubFragment.TAB_ITEM, roomTabItem), TuplesKt.a(RoomPostSubFragment.TAB_INDEX, Integer.valueOf(i)), TuplesKt.a("parent_type", str)}));
    ...
    public static final class b implements ij.q {
        ...
        @Override // ij.q
        public void a(int i) {
            if (RoomPostSubFragment.this.curExposurePosition < i) {
                RoomPostSubFragment.this.curExposurePosition = i;
            }
        }
    }
    ...
    public static final Unit initViewModel$lambda$3(RoomPostSubFragment roomPostSubFragment, Pair pair) {
        ...
        if (g2 != null && g2.length() != 0) {
            roomPostSubFragment.pageFrom = kVar.g();
            kVar.r(null);
        }
        if (roomPostSubFragment.pageFrom != null && (logViewConfig = roomPostSubFragment.getLogViewConfig()) != null && (g = logViewConfig.g()) != null) {
        }
        ...
        wn.p pVar = (wn.p) roomPostSubFragment.getMViewBinding();
    ...
    private final void trySaveDataCache(boolean isSaveInstance) {
        ...
        if (i2 > 0 && size > i2) {
            ...
            int i4 = bVar.b().getInt("post_sub_page_cache_code", 0);
            ...
            bVar.b().putString("post_sub_page_cache_" + tabId, j);
        }
    }
    ...
    public void initViewModel() {
        ...
        if (mViewModel != null && (Q = mViewModel.Q()) != null) {
            Q.j(this, new c(new Function1() { // from class: com.transsion.postdetail.ui.fragment.z4
        ...
        getTrendingImageRoomsViewModel().b().j(this, new c(new Function1() { // from class: com.transsion.postdetail.ui.fragment.a5
            public final Object invoke(Object obj) {
    ...
    public void loadData(boolean isFirstLoad, boolean isRefresh) {
        ...
        RoomPostViewModel.J(mViewModel, isFirstLoad, isRefresh, mTopTab.getTabId(), getMPage(), this.insertPostId, 0, 32, null);
    }
