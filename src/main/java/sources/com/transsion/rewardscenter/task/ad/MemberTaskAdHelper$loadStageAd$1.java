...
final class MemberTaskAdHelper$loadStageAd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ MemberTaskAdHelper this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MemberTaskAdHelper$loadStageAd$1(MemberTaskAdHelper memberTaskAdHelper, Continuation<? super MemberTaskAdHelper$loadStageAd$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            this.this$0.S();
            int e = RangesKt.e(MemberTaskAdHelper.r.b(), 2);
            biddingSspNativeManager = this.this$0.i;
