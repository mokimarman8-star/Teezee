    ...
    */
    ...
    public static final Unit d(final SpeechRecognizerView speechRecognizerView) {
        ...
        if (appCompatActivity != null) {
            cf.c.a.e(appCompatActivity).b(new String[]{"android.permission.RECORD_AUDIO"}).b().a(new df.b() { // from class: com.transsion.search_pugc.speech.n
            ...
            }).d(new df.c() { // from class: com.transsion.search_pugc.speech.o
