...
final class UpdateManager$startCheckUpdate$1 extends ContinuationImpl {
    int label;
    /* synthetic */ Object result;
    final /* synthetic */ UpdateManager this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    UpdateManager$startCheckUpdate$1(UpdateManager updateManager, Continuation<? super UpdateManager$startCheckUpdate$1> continuation) {
        super(continuation);
