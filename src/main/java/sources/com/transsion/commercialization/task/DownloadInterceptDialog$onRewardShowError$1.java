...
final class DownloadInterceptDialog$onRewardShowError$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ DownloadInterceptDialog this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DownloadInterceptDialog$onRewardShowError$1(DownloadInterceptDialog downloadInterceptDialog, Continuation<? super DownloadInterceptDialog$onRewardShowError$1> continuation) {
