...
@DebugMetadata(c = "com.transsion.player.longvideo.ui.dialog.LongVodPlayerViewAdHelper$loadInterstitialAd$1", f = "LongVodPlayerViewAdHelper.kt", l = {963}, m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: /home/user/Teezee-git/app_source/classes6.dex */
final class LongVodPlayerViewAdHelper$loadInterstitialAd$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    final /* synthetic */ Context $ctx;
    int label;
    final /* synthetic */ LongVodPlayerViewAdHelper this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    LongVodPlayerViewAdHelper$loadInterstitialAd$1(Context context, LongVodPlayerViewAdHelper longVodPlayerViewAdHelper, Continuation<? super LongVodPlayerViewAdHelper$loadInterstitialAd$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new LongVodPlayerViewAdHelper$loadInterstitialAd$1(this.$ctx, this.this$0, continuation);
    }
        ...
        if (i == 0) {
            ...
            if (appCompatActivity3 != null) {
                ...
                if (appCompatActivity2 != null) {
                    this.this$0.X = new BiddingInterstitialManager();
                    biddingInterstitialManager = this.this$0.X;
                    if (biddingInterstitialManager != null) {
                        str = this.this$0.i0;
                        biddingInterstitialManager.L0(str);
                    }
                    biddingInterstitialManager2 = this.this$0.X;
                    if (biddingInterstitialManager2 != null) {
                        com.transsion.ad.strategy.c cVar = com.transsion.ad.strategy.c.a;
                        j0 = this.this$0.j0();
                        biddingInterstitialManager2.J0(cVar.a(j0));
                    }
                    biddingInterstitialManager3 = this.this$0.X;
                    if (biddingInterstitialManager3 != null) {
                        biddingInterstitialManager3.I0(appCompatActivity2);
                    }
                    biddingInterstitialManager4 = this.this$0.X;
                    if (biddingInterstitialManager4 != null) {
                        aVar = this.this$0.t0;
                        biddingInterstitialManager4.K0(aVar);
                    }
                    biddingInterstitialManager5 = this.this$0.X;
