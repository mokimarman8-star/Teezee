...
final class LocationPlaceHelper$getCurrentLocation$2$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    LocationPlaceHelper$getCurrentLocation$2$1(double d, double d2, Function1<? super LocationPlace, Unit> function1, Continuation<? super LocationPlaceHelper$getCurrentLocation$2$1> continuation) {
        super(2, continuation);
        this.$latitude = d;
        this.$longitude = d2;
        this.$callback = function1;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            wf.a.a.c("LocationP", "Location--------------2 success " + this.$longitude + ", :" + this.$latitude + ", address:" + m, true);
