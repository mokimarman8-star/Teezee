...
public final /* data */ class UgcTrendingHomeBean implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final UgcTrendingHomeBean[] newArray(int i) {
            return new UgcTrendingHomeBean[i];
        }
    }

    public UgcTrendingHomeBean(PagerTrending pagerTrending, List<ItemTrending> list) {
        Intrinsics.h(pagerTrending, "pager");
        this.pager = pagerTrending;
        this.items = list;
    }

    public /* synthetic */ UgcTrendingHomeBean(PagerTrending pagerTrending, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? new PagerTrending(false, null, null, 0, 0, 31, null) : pagerTrending, list);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ UgcTrendingHomeBean copy$default(UgcTrendingHomeBean ugcTrendingHomeBean, PagerTrending pagerTrending, List list, int i, Object obj) {
        if ((i & 1) != 0) {
