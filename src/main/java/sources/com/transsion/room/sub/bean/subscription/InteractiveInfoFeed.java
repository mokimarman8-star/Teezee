...
public final /* data */ class InteractiveInfoFeed implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final InteractiveInfoFeed[] newArray(int i) {
            return new InteractiveInfoFeed[i];
        }
    }
    ...
    public InteractiveInfoFeed(String str, boolean z, String str2, boolean z2, String str3, String str4, String str5) {
        this.likeNum = str;
        this.hasLike = z;
    ...
    public /* synthetic */ InteractiveInfoFeed(String str, boolean z, String str2, boolean z2, String str3, String str4, String str5, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : str, (i & 2) != 0 ? false : z, (i & 4) != 0 ? null : str2, (i & 8) == 0 ? z2 : false, (i & 16) != 0 ? null : str3, (i & 32) != 0 ? null : str4, (i & 64) != 0 ? null : str5);
    }

    public static /* synthetic */ InteractiveInfoFeed copy$default(InteractiveInfoFeed interactiveInfoFeed, String str, boolean z, String str2, boolean z2, String str3, String str4, String str5, int i, Object obj) {
        if ((i & 1) != 0) {
            str = interactiveInfoFeed.likeNum;
        }
        if ((i & 2) != 0) {
            z = interactiveInfoFeed.hasLike;
        }
        boolean z3 = z;
        if ((i & 4) != 0) {
        ...
        String str6 = str2;
        if ((i & 8) != 0) {
            z2 = interactiveInfoFeed.hasFavorite;
        }
        boolean z4 = z2;
        if ((i & 16) != 0) {
        ...
        return interactiveInfoFeed.copy(str, z3, str6, z4, str7, str8, str5);
    }
