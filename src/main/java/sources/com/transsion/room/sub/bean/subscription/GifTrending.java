...
public final /* data */ class GifTrending implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final GifTrending[] newArray(int i) {
            return new GifTrending[i];
        }
    }
    ...
    */
    ...
    public /* synthetic */ GifTrending(String str, String str2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : str, (i & 2) != 0 ? null : str2);
    }

    public static /* synthetic */ GifTrending copy$default(GifTrending gifTrending, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
