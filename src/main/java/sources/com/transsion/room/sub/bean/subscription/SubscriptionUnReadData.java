...
public final /* data */ class SubscriptionUnReadData implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final SubscriptionUnReadData[] newArray(int i) {
            return new SubscriptionUnReadData[i];
        }
    }
    ...
    public SubscriptionUnReadData(int i) {
        this.unreadCount = i;
    }

    public /* synthetic */ SubscriptionUnReadData(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 0 : i);
    }

    public static /* synthetic */ SubscriptionUnReadData copy$default(SubscriptionUnReadData subscriptionUnReadData, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = subscriptionUnReadData.unreadCount;
        }
        return subscriptionUnReadData.copy(i);
    }
