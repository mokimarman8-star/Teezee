...
public final /* data */ class OperatingInfoTrending implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final OperatingInfoTrending[] newArray(int i) {
            return new OperatingInfoTrending[i];
        }
    }
    ...
    public OperatingInfoTrending(String str, String str2, int i) {
        this.tag = str;
        this.appointmentDate = str2;
        this.appointmentCnt = i;
    }

    public /* synthetic */ OperatingInfoTrending(String str, String str2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? null : str, (i2 & 2) != 0 ? null : str2, (i2 & 4) != 0 ? 0 : i);
    }

    public static /* synthetic */ OperatingInfoTrending copy$default(OperatingInfoTrending operatingInfoTrending, String str, String str2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        if ((i2 & 4) != 0) {
            i = operatingInfoTrending.appointmentCnt;
        }
        return operatingInfoTrending.copy(str, str2, i);
    }
