...
final class RoomViewModel$getMyRooms$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.room.viewmodel.RoomViewModel$getMyRooms$1$1", f = "RoomViewModel.kt", l = {119, 121, 123}, m = "invokeSuspend")
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.b, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(RoomViewModel roomViewModel, String str, int i, String str2, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.L$0 = bVar;
                this.label = 1;
                a = a.C0077a.a(K, a2, str, i2, str2, 0, 0, this, 48, null);
                if (a == f) {
                    return f;
                }
            } else {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RoomViewModel$getMyRooms$1(RoomViewModel roomViewModel, String str, int i, String str2, boolean z, Continuation<? super RoomViewModel$getMyRooms$1> continuation) {
        super(2, continuation);
        this.this$0 = roomViewModel;
        this.$page = str;
        this.$perPage = i;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.t(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.this$0, this.$page, this.$perPage, this.$userId, null)), y0.b()), new AnonymousClass2(null));
