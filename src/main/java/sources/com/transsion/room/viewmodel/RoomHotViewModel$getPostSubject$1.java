...
@DebugMetadata(c = "com.transsion.room.viewmodel.RoomHotViewModel$getPostSubject$1", f = "RoomHotViewModel.kt", l = {115}, m = "invokeSuspend")
/* loaded from: /home/user/Teezee-git/app_source/classes6.dex */
final class RoomHotViewModel$getPostSubject$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.room.viewmodel.RoomHotViewModel$getPostSubject$1$1", f = "RoomHotViewModel.kt", l = {102, Worker.WHAT_QUIT}, m = "invokeSuspend")
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.b, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(RoomHotViewModel roomHotViewModel, String str, String str2, int i, String str3, boolean z, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.L$0 = bVar;
                this.label = 1;
                obj = Z.j(a, str, str2, i2, str3, z, this);
                if (obj == f) {
                    return f;
                }
            } else {
    ...
    static final class a implements kotlinx.coroutines.flow.b {
        final /* synthetic */ RoomHotViewModel a;

        a(RoomHotViewModel roomHotViewModel) {
            this.a = roomHotViewModel;
        }
        ...
        public final Object emit(PostSubjectBean postSubjectBean, Continuation continuation) {
            ...
            if (postSubjectBean != null) {
                RoomHotViewModel roomHotViewModel = this.a;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RoomHotViewModel$getPostSubject$1(RoomHotViewModel roomHotViewModel, String str, String str2, int i, String str3, boolean z, Continuation<? super RoomHotViewModel$getPostSubject$1> continuation) {
        super(2, continuation);
        this.this$0 = roomHotViewModel;
        this.$subjectId = str;
        this.$page = str2;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.t(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.this$0, this.$subjectId, this.$page, this.$perPage, this.$sortType, this.$with, null)), y0.b()), new AnonymousClass2(null));
