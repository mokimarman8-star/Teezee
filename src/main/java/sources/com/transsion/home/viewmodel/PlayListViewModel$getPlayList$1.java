...
final class PlayListViewModel$getPlayList$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    PlayListViewModel$getPlayList$1(PlayListViewModel playListViewModel, String str, String str2, String str3, String str4, int i, Continuation<? super PlayListViewModel$getPlayList$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i2 == 0) {
                ...
                int i3 = this.$tabId;
                this.label = 1;
                b = b.a.b(bVar, null, e, i, str, str2, str3, str4, i3, this, 1, null);
                if (b == f) {
                    return f;
                }
            } else {
