...
final class MainXMLPreloadControlImp$1$postListDeferred$1 extends SuspendLambda implements Function2<n0, Continuation<? super View>, Object> {
    final /* synthetic */ Activity $activity;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MainXMLPreloadControlImp$1$postListDeferred$1(Activity activity, Continuation<? super MainXMLPreloadControlImp$1$postListDeferred$1> continuation) {
    ...
    public final Object invoke(n0 n0Var, Continuation<? super View> continuation) {
        return ((MainXMLPreloadControlImp$1$postListDeferred$1) create(n0Var, continuation)).invokeSuspend(Unit.a);
    }
