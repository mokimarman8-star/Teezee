...
@DebugMetadata(c = "com.transsion.home.adapter.suboperate.adapter.SubFilterAdapter$convert$1", f = "SubFilterAdapter.kt", l = {79}, m = "invokeSuspend")
...
final class SubFilterAdapter$convert$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    SubFilterAdapter$convert$1(FilterItem filterItem, ImageView imageView, Continuation<? super SubFilterAdapter$convert$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (image != null && (url = image.getUrl()) != null) {
                ...
                this.label = 1;
                if (kotlinx.coroutines.i.g(c, subFilterAdapter$convert$1$1$1, this) == f) {
                    return f;
                }
            }
        } else {
