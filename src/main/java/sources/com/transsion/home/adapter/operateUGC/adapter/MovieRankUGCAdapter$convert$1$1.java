...
final class MovieRankUGCAdapter$convert$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.home.adapter.operateUGC.adapter.MovieRankUGCAdapter$convert$1$1$1", f = "MovieRankUGCAdapter.kt", l = {82}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MovieRankUGCAdapter$convert$1$1(UGCVideo uGCVideo, ShapeableImageView shapeableImageView, Continuation<? super MovieRankUGCAdapter$convert$1$1> continuation) {
        super(2, continuation);
        this.$ugcVideo = uGCVideo;
        this.$this_apply = shapeableImageView;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.t(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.$ugcVideo, this.$this_apply, null)), y0.b()), new AnonymousClass2(null));
