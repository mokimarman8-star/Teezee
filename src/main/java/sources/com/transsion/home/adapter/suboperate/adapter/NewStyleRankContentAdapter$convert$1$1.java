...
@DebugMetadata(c = "com.transsion.home.adapter.suboperate.adapter.NewStyleRankContentAdapter$convert$1$1", f = "NewStyleRankContentAdapter.kt", l = {TidConfigBean.REASON_DB_EXCEPTION}, m = "invokeSuspend")
...
final class NewStyleRankContentAdapter$convert$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.home.adapter.suboperate.adapter.NewStyleRankContentAdapter$convert$1$1$1", f = "NewStyleRankContentAdapter.kt", l = {103}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    NewStyleRankContentAdapter$convert$1$1(Subject subject, ShapeableImageView shapeableImageView, Continuation<? super NewStyleRankContentAdapter$convert$1$1> continuation) {
        super(2, continuation);
        this.$item = subject;
        this.$this_apply = shapeableImageView;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.t(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.$item, this.$this_apply, null)), y0.b()), new AnonymousClass2(null));
