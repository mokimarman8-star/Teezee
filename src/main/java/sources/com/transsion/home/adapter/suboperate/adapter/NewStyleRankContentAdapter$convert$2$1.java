...
@DebugMetadata(c = "com.transsion.home.adapter.suboperate.adapter.NewStyleRankContentAdapter$convert$2$1", f = "NewStyleRankContentAdapter.kt", l = {136}, m = "invokeSuspend")
...
final class NewStyleRankContentAdapter$convert$2$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.home.adapter.suboperate.adapter.NewStyleRankContentAdapter$convert$2$1$1", f = "NewStyleRankContentAdapter.kt", l = {133}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    NewStyleRankContentAdapter$convert$2$1(Subject subject, ShapeableImageView shapeableImageView, Continuation<? super NewStyleRankContentAdapter$convert$2$1> continuation) {
        super(2, continuation);
        this.$item = subject;
        this.$this_apply = shapeableImageView;
    }
