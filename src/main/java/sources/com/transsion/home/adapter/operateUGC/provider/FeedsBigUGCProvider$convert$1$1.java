...
final class FeedsBigUGCProvider$convert$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FeedsBigUGCProvider$convert$1$1(UGCVideo uGCVideo, ShapeableImageView shapeableImageView, Continuation<? super FeedsBigUGCProvider$convert$1$1> continuation) {
        super(2, continuation);
        this.$ugcVideo = uGCVideo;
        this.$this_apply = shapeableImageView;
    }
