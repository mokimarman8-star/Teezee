...
final class SubHorizontalViewPagerAdapter$onBindViewHolder$1$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    final /* synthetic */ Bitmap $bitmap;
    final /* synthetic */ SubHorizontalViewPagerAdapter.a $holder;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    SubHorizontalViewPagerAdapter$onBindViewHolder$1$1$1(SubHorizontalViewPagerAdapter.a aVar, Bitmap bitmap, Continuation<? super SubHorizontalViewPagerAdapter$onBindViewHolder$1$1$1> continuation) {
