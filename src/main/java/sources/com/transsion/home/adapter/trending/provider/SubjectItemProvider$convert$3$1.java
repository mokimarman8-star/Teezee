...
@DebugMetadata(c = "com.transsion.home.adapter.trending.provider.SubjectItemProvider$convert$3$1", f = "SubjectItemProvider.kt", l = {Worker.WHAT_QUIT}, m = "invokeSuspend")
/* loaded from: /home/user/Teezee-git/app_source/classes6.dex */
final class SubjectItemProvider$convert$3$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.home.adapter.trending.provider.SubjectItemProvider$convert$3$1$1", f = "SubjectItemProvider.kt", l = {TidConfigBean.REASON_SAMPLING_RATE}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    SubjectItemProvider$convert$3$1(Ref.ObjectRef<String> objectRef, ShapeableImageView shapeableImageView, Continuation<? super SubjectItemProvider$convert$3$1> continuation) {
        super(2, continuation);
        this.$url = objectRef;
        this.$this_apply = shapeableImageView;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.t(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.$url, this.$this_apply, null)), y0.b()), new AnonymousClass2(null));
