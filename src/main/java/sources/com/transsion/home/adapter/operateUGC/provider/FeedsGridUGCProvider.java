...
public final class FeedsGridUGCProvider extends com.transsion.home.adapter.trending.provider.b {
    private final int e;
    private final int f;
    private final Lazy g = LazyKt.b(new Function0() { // from class: com.transsion.home.adapter.operateUGC.provider.f
    ...
    public FeedsGridUGCProvider(int i, int i2) {
        this.e = i2;
        this.f = (com.blankj.utilcode.util.y.e() - lj.a.a(((i - 1) * 8) + 24.0f)) / i;
    }
    ...
    public static final void G(OperateItem operateItem, FeedsGridUGCProvider feedsGridUGCProvider, BaseViewHolder baseViewHolder, View view) {
        ...
        if (feedsUGCVideo != null) {
            Integer valueOf = Integer.valueOf(feedsGridUGCProvider.e);
        ...
        rk.d.c.c(baseViewHolder.getLayoutPosition(), operateItem, feedsGridUGCProvider.e);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final rk.d I(FeedsGridUGCProvider feedsGridUGCProvider) {
        return new rk.d(SubTabFragment.INSTANCE.a(feedsGridUGCProvider.e));
    }
    ...
    public void b(final BaseViewHolder baseViewHolder, final OperateItem operateItem) {
        ...
        if (viewOrNull != null) {
            if (feedsUGCVideo.getBuiltIn()) {
                kotlinx.coroutines.i.d(o0.a(y0.c()), (CoroutineContext) null, (CoroutineStart) null, new FeedsGridUGCProvider$convert$1$1(feedsUGCVideo, viewOrNull, null), 3, (Object) null);
            } else {
                f.a aVar = ni.f.a;
        ...
        if (i == companion.g()) {
            ...
            baseViewHolder.setGone(R.id.main_op_trending_grid_type_icon, true);
        }
        ...
        if (feedsUGCVideo.isVerticalImmStyle()) {
            ...
            if (companion.h(Integer.valueOf(this.e), false)) {
        ...
        ((RecyclerView.a0) baseViewHolder).itemView.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.home.adapter.operateUGC.provider.g
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FeedsGridUGCProvider.G(OperateItem.this, this, baseViewHolder, view);
            }
        });
        if (this.e != HomeTabId.UGC_Trending.getValue()) {
