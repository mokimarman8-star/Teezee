...
public final /* data */ class BannerData implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final BannerData createFromParcel(Parcel parcel) {
            ...
            Image readSerializable = parcel.readSerializable();
            ...
            return new BannerData(readString, readString2, readSerializable, z, valueOf, parcel.readInt() != 0 ? Integer.valueOf(parcel.readInt()) : null, parcel.readString(), parcel.readString(), parcel.readInt(), parcel.readSerializable(), parcel.readString(), parcel.readParcelable(BannerData.class.getClassLoader()));
        }
    ...
    public BannerData() {
        this(null, null, null, false, null, null, null, null, 0, null, null, null, 4095, null);
    }

    public BannerData(String str, String str2, Image image, boolean z, Boolean bool, Integer num, String str3, String str4, int i, Subject subject, String str5, BiddingIntermediateMaterialBean biddingIntermediateMaterialBean) {
        this.content = str;
        this.deepLink = str2;
        this.image = image;
        this.builtIn = z;
    ...
    public /* synthetic */ BannerData(String str, String str2, Image image, boolean z, Boolean bool, Integer num, String str3, String str4, int i, Subject subject, String str5, BiddingIntermediateMaterialBean biddingIntermediateMaterialBean, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? null : str, (i2 & 2) != 0 ? null : str2, (i2 & 4) != 0 ? null : image, (i2 & 8) != 0 ? false : z, (i2 & 16) != 0 ? null : bool, (i2 & 32) != 0 ? 0 : num, (i2 & 64) != 0 ? null : str3, (i2 & 128) != 0 ? null : str4, (i2 & 256) == 0 ? i : 0, (i2 & DownloadException.EXCEPTION_IO_SSL_PEER_UNVERIFIED) != 0 ? null : subject, (i2 & 1024) != 0 ? null : str5, (i2 & 2048) == 0 ? biddingIntermediateMaterialBean : null);
    }
