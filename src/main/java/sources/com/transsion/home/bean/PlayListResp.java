...
public final /* data */ class PlayListResp implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final PlayListResp createFromParcel(Parcel parcel) {
            ...
            return new PlayListResp(readSerializable, valueOf, arrayList, arrayList2, parcel.readString(), parcel.readString());
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public final PlayListResp[] newArray(int i) {
            return new PlayListResp[i];
        }
    }
    ...
    public static /* synthetic */ PlayListResp copy$default(PlayListResp playListResp, Pager pager, Boolean bool, List list, List list2, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
