...
@DebugMetadata(c = "com.transsion.home.view.RankingAdapter$convert$2$1", f = "RankingAdapter.kt", l = {51}, m = "invokeSuspend")
/* loaded from: /home/user/Teezee-git/app_source/classes6.dex */
final class RankingAdapter$convert$2$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    RankingAdapter$convert$2$1(Subject subject, ShapeableImageView shapeableImageView, Continuation<? super RankingAdapter$convert$2$1> continuation) {
        super(2, continuation);
        this.$item = subject;
        this.$this_apply = shapeableImageView;
    }
