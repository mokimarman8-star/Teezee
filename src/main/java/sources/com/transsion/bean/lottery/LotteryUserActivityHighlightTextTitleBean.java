...
public final /* data */ class LotteryUserActivityHighlightTextTitleBean implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final LotteryUserActivityHighlightTextTitleBean[] newArray(int i) {
            return new LotteryUserActivityHighlightTextTitleBean[i];
        }
    }
    ...
    public static /* synthetic */ LotteryUserActivityHighlightTextTitleBean copy$default(LotteryUserActivityHighlightTextTitleBean lotteryUserActivityHighlightTextTitleBean, String str, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
