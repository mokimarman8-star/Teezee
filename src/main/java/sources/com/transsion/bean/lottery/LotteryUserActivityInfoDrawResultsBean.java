...
public final /* data */ class LotteryUserActivityInfoDrawResultsBean implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator {
        ...
        public final LotteryUserActivityInfoDrawResultsBean[] newArray(int i) {
            return new LotteryUserActivityInfoDrawResultsBean[i];
        }
    }
    ...
    public /* synthetic */ LotteryUserActivityInfoDrawResultsBean(String str, String str2, LotteryUserActivityInfoPriceBean lotteryUserActivityInfoPriceBean, String str3, String str4, String str5, String str6, String str7, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public final LotteryUserActivityInfoDrawResultsBean copy(String id, String activityId, LotteryUserActivityInfoPriceBean price, String needClaim, String claimStatus, String needFill, String fillStatus, String fulfillStatus) {
        return new LotteryUserActivityInfoDrawResultsBean(id, activityId, price, needClaim, claimStatus, needFill, fillStatus, fulfillStatus);
    }
