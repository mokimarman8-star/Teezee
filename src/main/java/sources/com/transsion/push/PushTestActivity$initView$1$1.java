...
final class PushTestActivity$initView$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    int label;

    PushTestActivity$initView$1$1(Continuation<? super PushTestActivity$initView$1$1> continuation) {
