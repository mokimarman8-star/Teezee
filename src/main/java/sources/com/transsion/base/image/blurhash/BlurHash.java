...
public final class BlurHash {
    ...
    public final void f(String str, int i, int i2, Function1 function1) {
        Intrinsics.h(str, "blurString");
        Intrinsics.h(function1, "response");
        i.d(this.d, (CoroutineContext) null, (CoroutineStart) null, new BlurHash$execute$1(this, str, function1, i, i2, null), 3, (Object) null);
    }
}
