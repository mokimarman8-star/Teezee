...
public final /* data */ class MySubject implements Serializable {
    ...
    public MySubject(int i, int i2, List<CoverUrl> list) {
    ...
    public static /* synthetic */ MySubject copy$default(MySubject mySubject, int i, int i2, List list, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = mySubject.wantToSeeCount;
        }
        if ((i3 & 2) != 0) {
            i2 = mySubject.haveSeenCount;
        }
        if ((i3 & 4) != 0) {
            list = mySubject.wantSubjects;
        }
        return mySubject.copy(i, i2, list);
    }
