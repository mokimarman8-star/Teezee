...
public final class e extends BaseQuickAdapter {
    ...
    public static final void D1(e eVar, SkuItem skuItem, View view) {
        a.a.g(wf.a.a, "Should redeem", false, 2, (Object) null);
        Function2<? super SkuItem, ? super View, Unit> function2 = eVar.clickCallback;
        if (function2 != null) {
            Intrinsics.e(view);
    ...
    public void F(BaseViewHolder holder, final SkuItem item) {
        ...
        AppCompatTextView view = holder.getView(R$id.title);
        view.setText(view.getContext().getString(R$string.member_sku_set_title, item.getDurationCount(), item.getDurationUnitDesc()));
        holder.getView(R$id.price).setText(m0.a(new BigDecimal(String.valueOf(item.getPrice()))).toPlainString());
        ...
        AppCompatTextView appCompatTextView = this.redeemBtn;
        if (appCompatTextView != null) {
            appCompatTextView.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.member.adapter.d
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    e.D1(e.this, item, view2);
                }
            });
        }
    }
