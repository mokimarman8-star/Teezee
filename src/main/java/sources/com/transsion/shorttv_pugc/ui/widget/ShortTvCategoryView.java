...
public final class ShortTvCategoryView extends LinearLayoutCompat {
    ...
    private final void g() {
        this.viewBinding.d.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.shorttv_pugc.ui.widget.h
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ShortTvCategoryView.h(ShortTvCategoryView.this, view);
            }
        });
        this.viewBinding.c.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.shorttv_pugc.ui.widget.i
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ShortTvCategoryView.i(ShortTvCategoryView.this, view);
            }
        });
        this.viewBinding.b.setOnClickListener(new View.OnClickListener() { // from class: com.transsion.shorttv_pugc.ui.widget.j
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
