...
public final class ShortTvDownloadEpListAdapter extends RecyclerView.Adapter {
    ...
    public static final void j(ShortTvDownloadEpListAdapter shortTvDownloadEpListAdapter, rs.c cVar, View view) {
        Function1 function1 = shortTvDownloadEpListAdapter.b;
        if (function1 != null) {
    ...
    public void onBindViewHolder(EpisodeViewHolder holder, int i) {
        ...
        final rs.c cVar = (rs.c) this.a.get(i);
    ...
    /* JADX WARN: Type inference failed for: r4v2, types: [android.view.View, com.transsion.shorttv_pugc.ui.widget.ShortTvDownloadEpItemView] */
