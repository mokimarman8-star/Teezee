...
public final /* data */ class ShortTvSubtitleBean implements Serializable {
    ...
    public ShortTvSubtitleBean(String subjectId, String str, int i, int i2, String str2) {
    ...
    public final ShortTvSubtitleBean copy(String subjectId, String id, int ep, int se, String videoId) {
        Intrinsics.h(subjectId, "subjectId");
        return new ShortTvSubtitleBean(subjectId, id, ep, se, videoId);
    }
