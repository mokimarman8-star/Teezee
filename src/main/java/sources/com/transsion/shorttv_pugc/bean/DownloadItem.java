...
public final /* data */ class DownloadItem implements Serializable {
    ...
    public DownloadItem(String str, String str2, String str3, int i, Long l, String str4, String str5, Integer num, int i2, int i3, int i4, String str6, Integer num2, Integer num3, String str7) {
        ...
        this.position = -1;
        this.taskId = HttpUrl.FRAGMENT_ENCODE_SET;
    }
    ...
    public final DownloadItem copy(String resourceId, String name, String url, int linkType, Long size, String uploadBy, String postId, Integer epse, int se, int ep, int status, String sourceUrl, Integer resolution, Integer requireMemberType, String memberIcon) {
        return new DownloadItem(resourceId, name, url, linkType, size, uploadBy, postId, epse, se, ep, status, sourceUrl, resolution, requireMemberType, memberIcon);
    }
