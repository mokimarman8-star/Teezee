...
public class ShimmerConstraintLayout extends ConstraintLayout {
    ...
    @TargetApi(Sdk$SDKMetric.SDKMetricType.WIN_NOTIF_SUCCESS_VALUE)
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            setShimmer(((obtainStyledAttributes.hasValue(R.styleable.ShortTvShimmerConstraintLayout_short_tv_shimmer_colored) && obtainStyledAttributes.getBoolean(R.styleable.ShortTvShimmerConstraintLayout_short_tv_shimmer_colored, false)) ? new a.c() : new a.C0006a()).c(obtainStyledAttributes).a());
