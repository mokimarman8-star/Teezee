    ...
    public static final class c implements GestureDetector.OnGestureListener {
        ...
        public boolean onScroll(MotionEvent motionEvent, MotionEvent e2, float f, float f2) {
            ...
            if (e.this.e) {
                a aVar = e.this.i;
                if (aVar != null) {
                    aVar.b(motionEvent.getX(), e2.getX());
                }
            } else if (e.this.j) {
                e eVar = e.this;
                View view = eVar.k;
                ...
                if (eVar.o(view, (int) this.a)) {
                    ...
                    a aVar2 = e.this.i;
                    if (aVar2 != null) {
                        aVar2.c(motionEvent.getY(), e2.getY());
                    }
                } else {
                    e eVar2 = e.this;
                    View view2 = eVar2.k;
                    ...
                    if (eVar2.q(view2, (int) this.a)) {
                        ...
                        a aVar3 = e.this.i;
                        if (aVar3 != null) {
                            aVar3.d(motionEvent.getY(), e2.getY());
                        }
                    }
                }
                ...
                a aVar4 = e.this.i;
                if (aVar4 != null) {
                    aVar4.c(motionEvent.getY(), e2.getY());
                }
            } else if (e.this.p((int) this.a)) {
                e.this.f = true;
                a aVar5 = e.this.i;
                if (aVar5 != null) {
                    aVar5.d(motionEvent.getY(), e2.getY());
                }
            }
            return true;
        }
