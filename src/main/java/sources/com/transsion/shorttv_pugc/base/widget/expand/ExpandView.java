...
public class ExpandView extends TnTextView {
    ...
    private void i() {
        ...
        this.w = new ms.a(getContext(), this.t ? R.mipmap.short_tv_ic_down_more : -111, this.m, this.o, this.s, 0, z);
        this.v = new ms.a(getContext(), this.t ? R.mipmap.short_tv_ic_up_hide : -111, this.n, this.p, this.s, 0, z);
        ...
        setOnClickListener(new View.OnClickListener() { // from class: ms.b
    ...
    public /* synthetic */ CharSequence m(final CharSequence charSequence) {
        ...
        if (this.k) {
            postDelayed(new Runnable() { // from class: ms.d
    ...
    public void l(final CharSequence charSequence) {
        setTextAction(new Function0() { // from class: ms.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                CharSequence m;
                m = ExpandView.this.m(charSequence);
                return m;
            }
        });
    }
