...
final class ForYouSubjectProvider$convert$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(c = "com.transsion.moviedetail.adapter.ForYouSubjectProvider$convert$1$1$1", f = "ForYouAdapter.kt", l = {108}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ForYouSubjectProvider$convert$1$1(Subject subject, ShapeableImageView shapeableImageView, Continuation<? super ForYouSubjectProvider$convert$1$1> continuation) {
        super(2, continuation);
        this.$item = subject;
        this.$this_apply = shapeableImageView;
    }
