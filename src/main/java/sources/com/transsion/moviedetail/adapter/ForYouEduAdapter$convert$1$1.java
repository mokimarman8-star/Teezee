...
@DebugMetadata(c = "com.transsion.moviedetail.adapter.ForYouEduAdapter$convert$1$1", f = "ForYouEduAdapter.kt", l = {51}, m = "invokeSuspend")
...
final class ForYouEduAdapter$convert$1$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ForYouEduAdapter$convert$1$1(Subject subject, ShapeableImageView shapeableImageView, Continuation<? super ForYouEduAdapter$convert$1$1> continuation) {
        super(2, continuation);
        this.$item = subject;
        this.$this_apply = shapeableImageView;
    }
