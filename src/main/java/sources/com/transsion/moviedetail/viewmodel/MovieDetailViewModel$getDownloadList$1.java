...
final class MovieDetailViewModel$getDownloadList$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.b, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(MovieDetailViewModel movieDetailViewModel, String str, int i, int i2, int i3, int i4, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Integer d = Boxing.d(this.$resolution);
                int i2 = this.$se;
                int i3 = this.$epFrom;
                int i4 = this.$epTo;
                this.L$0 = bVar2;
                this.label = 1;
                c = a.a.c(O, a, str, (String) null, 0, 0, 0, 0, 2, d, i2, i3, i4, this, 120, (Object) null);
                obj2 = f;
                if (c == obj2) {
                    return obj2;
                }
    ...
    static final class a implements kotlinx.coroutines.flow.b {
        ...
        public final Object emit(DownloadListBean downloadListBean, Continuation continuation) {
            this.a.w().n(downloadListBean);
            return Unit.a;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MovieDetailViewModel$getDownloadList$1(MovieDetailViewModel movieDetailViewModel, String str, int i, int i2, int i3, int i4, Continuation<? super MovieDetailViewModel$getDownloadList$1> continuation) {
        super(2, continuation);
        this.this$0 = movieDetailViewModel;
        this.$subjectId = str;
        this.$resolution = i;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            kotlinx.coroutines.flow.a e = kotlinx.coroutines.flow.c.e(kotlinx.coroutines.flow.c.r(new AnonymousClass1(this.this$0, this.$subjectId, this.$resolution, this.$se, this.$epFrom, this.$epTo, null)), new AnonymousClass2(null));
