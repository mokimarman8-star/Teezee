...
@DebugMetadata(c = "com.transsion.moviedetail.viewmodel.HotViewModel$getPostSubject$1", f = "HotViewModel.kt", l = {TidConfigBean.REASON_DB_EXCEPTION}, m = "invokeSuspend")
/* loaded from: /home/user/Teezee-git/app_source/classes6.dex */
final class HotViewModel$getPostSubject$1 extends SuspendLambda implements Function2<n0, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<kotlinx.coroutines.flow.b, Continuation<? super Unit>, Object> {
        ...
        AnonymousClass1(HotViewModel hotViewModel, String str, String str2, int i, String str3, boolean z, Continuation<? super AnonymousClass1> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.L$0 = bVar;
                this.label = 1;
                obj = e0.e(a, str, str2, i2, str3, z, this);
                if (obj == f) {
                    return f;
                }
            } else {
    ...
    @DebugMetadata(c = "com.transsion.moviedetail.viewmodel.HotViewModel$getPostSubject$1$2", f = "HotViewModel.kt", l = {TidConfigBean.REASON_SAMPLING_RATE}, m = "invokeSuspend")
    ...
    static final class a implements kotlinx.coroutines.flow.b {
        ...
        public final Object emit(PostSubjectBean postSubjectBean, Continuation continuation) {
            ...
            if (postSubjectBean != null) {
                HotViewModel hotViewModel = this.a;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HotViewModel$getPostSubject$1(HotViewModel hotViewModel, String str, String str2, int i, String str3, boolean z, Continuation<? super HotViewModel$getPostSubject$1> continuation) {
        super(2, continuation);
        this.this$0 = hotViewModel;
        this.$subjectId = str;
        this.$page = str2;
