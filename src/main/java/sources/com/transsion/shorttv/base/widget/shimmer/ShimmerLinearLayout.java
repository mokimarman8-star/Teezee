...
public class ShimmerLinearLayout extends LinearLayout {
    ...
    private void a(Context context, AttributeSet attributeSet) {
        ...
        try {
            setShimmer(((obtainStyledAttributes.hasValue(R.styleable.ShortTvShimmerFrameLayout_short_tv_shimmer_colored) && obtainStyledAttributes.getBoolean(R.styleable.ShortTvShimmerFrameLayout_short_tv_shimmer_colored, false)) ? new a.c() : new a.C0060a()).c(obtainStyledAttributes).a());
