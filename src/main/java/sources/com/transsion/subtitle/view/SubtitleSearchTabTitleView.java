...
public final class SubtitleSearchTabTitleView extends BLTextView implements b, a {
    ...
    public void onDeselected(int index, int totalCount) {
        ...
        setBackground(new DrawableCreator.Builder().setCornersRadius(a0.a(8.0f)).setSolidColor(getContext().getResources().getColor(R.color.white_10)).build());
        setTextColor(-1);
    }
    ...
    public void onSelected(int index, int totalCount) {
        ...
        setBackground(new DrawableCreator.Builder().setCornersRadius(a0.a(8.0f)).setSolidColor(getContext().getResources().getColor(R.color.white)).build());
