...
@DebugMetadata(c = "com.tn.tranpay.helper.PayUtils$retryWithFixedIntervalAndTimeLimit$2", f = "PayUtils.kt", l = {TmcConstants.NOTIFY_ADDHOME_MFAH_SHOW}, m = "invokeSuspend")
...
final class PayUtils$retryWithFixedIntervalAndTimeLimit$2 extends SuspendLambda implements Function2<n0, Continuation<Object>, Object> {
    ...
    PayUtils$retryWithFixedIntervalAndTimeLimit$2(Function1<? super Continuation<Object>, ? extends Object> function1, Continuation<? super PayUtils$retryWithFixedIntervalAndTimeLimit$2> continuation) {
