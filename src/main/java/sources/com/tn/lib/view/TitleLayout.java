...
public final class TitleLayout extends ConstraintLayout {
    ...
    public TitleLayout(final Context context, AttributeSet attributeSet) {
        ...
        boolean z2 = obtainStyledAttributes.getBoolean(R.styleable.TitleLayout_showLine, true);
        int resourceId2 = obtainStyledAttributes.getResourceId(R.styleable.TitleLayout_menuRes, android.R.drawable.ic_menu_add);
        ...
        this.tvTitleText = findViewById(R$id.tv_titleText);
        ...
        if (imageView2 != null) {
            ...
            imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.tn.lib.view.v
    ...
    private final int i(Context context, float dp) {
