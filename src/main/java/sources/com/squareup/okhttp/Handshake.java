...
public final class Handshake {
    ...
    public static Handshake get(SSLSession sSLSession) {
        ...
        List k = certificateArr != null ? g.k(certificateArr) : Collections.emptyList();
        Certificate[] localCertificates = sSLSession.getLocalCertificates();
        return new Handshake(cipherSuite, k, localCertificates != null ? g.k(localCertificates) : Collections.emptyList());
    }
