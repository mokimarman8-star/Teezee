...
public final class v implements f4.a {
    ...
    public static v a(View view) {
        ...
        int i = R$id.iv_cover;
        ShapeableImageView a6 = f4.b.a(view, i);
        if (a6 == null || (a = f4.b.a(view, (i = R$id.iv_cover_bg))) == null || (a2 = f4.b.a(view, (i = R$id.tv_members))) == null || (a3 = f4.b.a(view, (i = R$id.tv_tag))) == null || (a4 = f4.b.a(view, (i = R$id.tv_title))) == null || (a5 = f4.b.a(view, (i = R$id.v_join))) == null) {
            throw new NullPointerException("Missing required view with ID: ".concat(view.getResources().getResourceName(i)));
        }
        return new v(constraintLayout, constraintLayout, a6, a, a2, a3, a4, a5);
    }
