    ...
    private final void writeControlFrame(int opcode, ByteString payload) throws IOException {
        ...
        if (this.isClient) {
            ...
            if (size > 0) {
                ...
                Intrinsics.e(buffer$UnsafeCursor);
