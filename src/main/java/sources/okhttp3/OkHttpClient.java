...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
            ...
            while (it.hasNext()) {
                if (((ConnectionSpec) it.next()).isTls()) {
                    if (builder.getSslSocketFactoryOrNull$okhttp() != null) {
                        ...
                        Intrinsics.e(x509TrustManagerOrNull$okhttp);
    ...
    public final List<ConnectionSpec> m64deprecated_connectionSpecs() {
    ...
    public final List<Interceptor> m72deprecated_interceptors() {
    ...
    public final List<Interceptor> m73deprecated_networkInterceptors() {
    ...
    public WebSocket newWebSocket(Request request, WebSocketListener listener) {
        ...
        RealWebSocket realWebSocket = new RealWebSocket(TaskRunner.INSTANCE, request, listener, new Random(), this.pingIntervalMillis, (WebSocketExtensions) null, this.minWebSocketMessageToCompress);
