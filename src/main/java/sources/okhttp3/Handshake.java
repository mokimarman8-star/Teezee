...
public final class Handshake {
    ...
    public static final class Companion {
        ...
        public final Handshake m55deprecated_get(SSLSession sslSession) throws IOException {
        ...
        public final Handshake get(TlsVersion tlsVersion, CipherSuite cipherSuite, List<? extends Certificate> peerCertificates, List<? extends Certificate> localCertificates) {
            ...
            return new Handshake(tlsVersion, cipherSuite, Util.toImmutableList(localCertificates), new get.1(Util.toImmutableList(peerCertificates)));
        }
    }
    ...
    public Handshake(TlsVersion tlsVersion, CipherSuite cipherSuite, List<? extends Certificate> list, final Function0<? extends List<? extends Certificate>> function0) {
        Intrinsics.h(tlsVersion, "tlsVersion");
        Intrinsics.h(cipherSuite, "cipherSuite");
        Intrinsics.h(list, "localCertificates");
        Intrinsics.h(function0, "peerCertificatesFn");
    ...
    public final List<Certificate> m50deprecated_localCertificates() {
    ...
    public final Principal m51deprecated_localPrincipal() {
    ...
    public final List<Certificate> m52deprecated_peerCertificates() {
    ...
    public final Principal m53deprecated_peerPrincipal() {
    ...
    public final Principal localPrincipal() {
        Object k0 = CollectionsKt.k0(this.localCertificates);
    ...
    public final Principal peerPrincipal() {
        Object k0 = CollectionsKt.k0(peerCertificates());
        X509Certificate x509Certificate = k0 instanceof X509Certificate ? (X509Certificate) k0 : null;
        if (x509Certificate != null) {
            return x509Certificate.getSubjectX500Principal();
        }
