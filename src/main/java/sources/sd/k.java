...
final class k {
    ...
    private synchronized void b() {
        if (this.a.isEmpty()) {
            ...
            a(new int[]{LogSeverity.NOTICE_VALUE, 379}, "FR");
            a(new int[]{380}, "BG");
            a(new int[]{383}, "SI");
            a(new int[]{385}, "HR");
            a(new int[]{387}, "BA");
            a(new int[]{LogSeverity.WARNING_VALUE, 440}, "DE");
            ...
            a(new int[]{LogSeverity.ERROR_VALUE, 509}, "GB");
            a(new int[]{520}, "GR");
            a(new int[]{528}, "LB");
            a(new int[]{529}, "CY");
            a(new int[]{531}, "MK");
            ...
            a(new int[]{594}, "RO");
            a(new int[]{599}, "HU");
            a(new int[]{LogSeverity.CRITICAL_VALUE, 601}, "ZA");
            a(new int[]{603}, "GH");
            a(new int[]{608}, "BH");
            a(new int[]{609}, "MU");
            a(new int[]{611}, "MA");
