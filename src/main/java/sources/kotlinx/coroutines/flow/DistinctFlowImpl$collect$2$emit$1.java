...
final class DistinctFlowImpl$collect$2$emit$1 extends ContinuationImpl {
    ...
    DistinctFlowImpl$collect$2$emit$1(DistinctFlowImpl$collect$2 distinctFlowImpl$collect$2, Continuation<? super DistinctFlowImpl$collect$2$emit$1> continuation) {
        super(continuation);
