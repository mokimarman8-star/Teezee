...
public final class SetBuilder<E> extends AbstractMutableSet<E> implements Set<E>, Serializable, KMutableSet {
    ...
    public SetBuilder(MapBuilder<E, ?> mapBuilder) {
        Intrinsics.h(mapBuilder, "backing");
