...
public class a {
    ...
    private static final String[] b = {"", "正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬", "腊"};
    private static final String[] c = {"甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸"};
    private static final String[] d = {"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥"};
    private static final String[] e = {"鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"};
    ...
    public static ArrayList d(int i) {
        ...
        if (g(i) != 0) {
            arrayList.add(g(i), "闰" + strArr[g(i)] + "月");
        }
        return arrayList;
    }
