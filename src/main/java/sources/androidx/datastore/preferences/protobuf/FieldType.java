...
public final class FieldType {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f7560b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f7560b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f7559a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f7559a[Collection.SCALAR.ordinal()] = 3;
    ...
    private FieldType(String str, int i5, int i6, Collection collection, JavaType javaType) {
        ...
        int i8 = a.f7559a[collection.ordinal()];
        if (i8 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i7 = a.f7560b[javaType.ordinal()]) == 1 || i7 == 2 || i7 == 3) ? false : true;
    }
