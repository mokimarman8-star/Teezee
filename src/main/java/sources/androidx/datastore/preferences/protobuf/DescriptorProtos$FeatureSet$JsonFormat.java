...
public enum DescriptorProtos$FeatureSet$JsonFormat implements w.a {
    ...
    private static final class b implements w.c {
        ...
        public boolean isInRange(int i5) {
            return DescriptorProtos$FeatureSet$JsonFormat.forNumber(i5) != null;
        }
    }

    DescriptorProtos$FeatureSet$JsonFormat(int i5) {
        this.value = i5;
    }

    public static DescriptorProtos$FeatureSet$JsonFormat forNumber(int i5) {
        if (i5 == 0) {
    ...
    @Deprecated
    public static DescriptorProtos$FeatureSet$JsonFormat valueOf(int i5) {
        return forNumber(i5);
    }
