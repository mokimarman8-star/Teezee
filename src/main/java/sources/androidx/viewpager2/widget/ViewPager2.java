...
public final class ViewPager2 extends ViewGroup {
    ...
    private class LinearLayoutManagerImpl extends LinearLayoutManager {
        ...
        protected void calculateExtraLayoutSpace(@NonNull RecyclerView.x xVar, @NonNull int[] iArr) {
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull RecyclerView.t tVar, @NonNull RecyclerView.x xVar, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        public void onInitializeAccessibilityNodeInfoForItem(@NonNull RecyclerView.t tVar, @NonNull RecyclerView.x xVar, @NonNull View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        public boolean performAccessibilityAction(@NonNull RecyclerView.t tVar, @NonNull RecyclerView.x xVar, int i, @Nullable Bundle bundle) {
            return ViewPager2.this.mAccessibilityProvider.handlesLmPerformAccessibilityAction(i) ? ViewPager2.this.mAccessibilityProvider.onLmPerformAccessibilityAction(i) : super.performAccessibilityAction(tVar, xVar, i, bundle);
        }
    ...
    private class PagerSnapHelperImpl extends n {
        PagerSnapHelperImpl() {
        }
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        this.mAccessibilityProvider = sFeatureEnhancedA11yEnabled ? new PageAwareAccessibilityProvider() : new BasicAccessibilityProvider(this);
        RecyclerViewImpl recyclerViewImpl = new RecyclerViewImpl(context);
        this.mRecyclerView = recyclerViewImpl;
        recyclerViewImpl.setId(ViewCompat.generateViewId());
        this.mRecyclerView.setDescendantFocusability(ASTNode.BLOCK_DO_UNTIL);
    ...
    protected void dispatchRestoreInstanceState(SparseArray<Parcelable> sparseArray) {
        ...
        if (savedState instanceof SavedState) {
            int i = savedState.mRecyclerViewId;
