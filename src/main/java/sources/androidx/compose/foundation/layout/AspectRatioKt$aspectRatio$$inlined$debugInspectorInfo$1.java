...
public final class AspectRatioKt$aspectRatio$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    ...
    public AspectRatioKt$aspectRatio$$inlined$debugInspectorInfo$1(float f5, boolean z5) {
        super(1);
    ...
    public final void invoke(z0 z0Var) {
        z0Var.b("aspectRatio");
        z0Var.a().b("ratio", Float.valueOf(this.$ratio$inlined));
        z0Var.a().b("matchHeightConstraintsFirst", Boolean.valueOf(this.$matchHeightConstraintsFirst$inlined));
    }
}
