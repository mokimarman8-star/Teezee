...
public final class AlignmentLineKt$paddingFrom4j6BHR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    ...
    public AlignmentLineKt$paddingFrom4j6BHR0$$inlined$debugInspectorInfo$1(androidx.compose.ui.layout.a aVar, float f5, float f6) {
        super(1);
    ...
    public final void invoke(z0 z0Var) {
        z0Var.b("paddingFrom");
        z0Var.a().b("alignmentLine", this.$alignmentLine$inlined);
        z0Var.a().b("before", o0.i.d(this.$before$inlined));
        z0Var.a().b("after", o0.i.d(this.$after$inlined));
    }
}
