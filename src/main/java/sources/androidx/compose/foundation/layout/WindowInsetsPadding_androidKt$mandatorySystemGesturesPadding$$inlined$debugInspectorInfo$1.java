...
public final class WindowInsetsPadding_androidKt$mandatorySystemGesturesPadding$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<z0, Unit> {
    ...
    public final void invoke(z0 z0Var) {
        z0Var.b("mandatorySystemGesturesPadding");
    }
}
