...
public final class LazyGridDslKt$itemsIndexed$3 extends Lambda implements Function2<c, Integer, a> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        ...
        return a.a(m73invoke_orMbw(null, ((Number) obj2).intValue()));
    }

    /* renamed from: invoke-_-orMbw, reason: not valid java name */
    public final long m73invoke_orMbw(c cVar, int i5) {
        return ((a) this.$span.invoke(cVar, Integer.valueOf(i5), this.$items.get(i5))).e();
    }
}
