...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        j0 v = j0.v(context, attributeSet, R$styleable.LinearLayoutCompat, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, R$styleable.LinearLayoutCompat, attributeSet, v.r(), i, 0);
        ...
        boolean a = v.a(R$styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!a) {
            setBaselineAligned(a);
        }
        this.mWeightSum = v.i(R$styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = v.k(R$styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = v.a(R$styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(v.g(R$styleable.LinearLayoutCompat_divider));
        this.mShowDividers = v.k(R$styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = v.f(R$styleable.LinearLayoutCompat_dividerPadding, 0);
        v.x();
    }
    ...
    private void a(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (virtualChildAt.getVisibility() != 8) {
                a layoutParams = virtualChildAt.getLayoutParams();
    ...
    void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < virtualChildCount; i2++) {
            ...
            if (virtualChildAt != null && virtualChildAt.getVisibility() != 8 && hasDividerBeforeChildAt(i2)) {
                a layoutParams = virtualChildAt.getLayoutParams();
                drawVerticalDivider(canvas, b ? virtualChildAt.getRight() + ((LinearLayout.LayoutParams) layoutParams).rightMargin : (virtualChildAt.getLeft() - ((LinearLayout.LayoutParams) layoutParams).leftMargin) - this.mDividerWidth);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            if (virtualChildAt2 != null) {
                a layoutParams2 = virtualChildAt2.getLayoutParams();
                if (b) {
    ...
    void drawDividersVertical(Canvas canvas) {
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            drawHorizontalDivider(canvas, virtualChildAt2 == null ? (getHeight() - getPaddingBottom()) - this.mDividerHeight : virtualChildAt2.getBottom() + ((LinearLayout.LayoutParams) virtualChildAt2.getLayoutParams()).bottomMargin);
        }
    }
    ...
    */
    ...
    void measureChildBeforeLayout(View view, int i, int i2, int i3, int i4, int i6) {
