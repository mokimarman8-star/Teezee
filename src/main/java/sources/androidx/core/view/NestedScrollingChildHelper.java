...
public class NestedScrollingChildHelper {
    ...
    private boolean dispatchNestedScrollInternal(int i, int i2, int i3, int i4, int[] iArr, int i6, int[] iArr2) {
        ...
        ViewParentCompat.onNestedScroll(nestedScrollingParentForType, this.mView, i, i2, i3, i4, i6, iArr3);
        if (iArr != null) {
            this.mView.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i7;
            iArr[1] = iArr[1] - i8;
    ...
    public void dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i6, int[] iArr2) {
        dispatchNestedScrollInternal(i, i2, i3, i4, iArr, i6, iArr2);
    }
    ...
    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr, int i6) {
        return dispatchNestedScrollInternal(i, i2, i3, i4, iArr, i6, null);
    }
