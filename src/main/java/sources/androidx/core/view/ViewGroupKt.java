...
import androidx.core.view.ViewGroupKt$special$;
...
public final class ViewGroupKt {
    ...
    public static final IntRange getIndices(ViewGroup viewGroup) {
        return RangesKt.s(0, viewGroup.getChildCount());
    }
    ...
    public static /* synthetic */ void updateMargins$default(ViewGroup.MarginLayoutParams marginLayoutParams, int i, int i2, int i3, int i4, int i6, Object obj) {
        if ((i6 & 1) != 0) {
    ...
    public static /* synthetic */ void updateMarginsRelative$default(ViewGroup.MarginLayoutParams marginLayoutParams, int i, int i2, int i3, int i4, int i6, Object obj) {
        if ((i6 & 1) != 0) {
