...
public abstract class c {
    ...
    private static final ThreadLocal f6794a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f6795b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f6794a;
        ...
        ThreadLocal threadLocal2 = f6795b;
