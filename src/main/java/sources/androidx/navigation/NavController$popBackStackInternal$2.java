...
final class NavController$popBackStackInternal$2 extends Lambda implements Function1<NavBackStackEntry, Unit> {
    ...
    NavController$popBackStackInternal$2(Ref.BooleanRef booleanRef, Ref.BooleanRef booleanRef2, NavController navController, boolean z5, ArrayDeque<NavBackStackEntryState> arrayDeque) {
        super(1);
    ...
    public final void invoke(NavBackStackEntry navBackStackEntry) {
        ...
        NavController.m(this.this$0, navBackStackEntry, this.$saveState, this.$savedState);
    }
}
