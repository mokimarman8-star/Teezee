...
public final class h extends BaseItemProvider {
    private final void A(BaseViewHolder baseViewHolder, PostSubjectItem postSubjectItem) {
        ...
        ShapeableImageView view = baseViewHolder.getView(R$id.iv_audio_cover_small);
        if (TextUtils.isEmpty(url)) {
            ...
            if (url != null) {
                int a = a0.a(24.0f);
                Glide.with(k()).load(url + "?x-oss-process=image/resize,w_" + a + ",h_" + a + ",m_lfit").into(view);
            }
        }
        final ShapeableImageView view2 = baseViewHolder.getView(R$id.iv_cover);
        String coverUrl = postSubjectItem.getCoverUrl(true);
        if (TextUtils.isEmpty(coverUrl)) {
            view2.setImageResource(R.mipmap.ic_audio_default_bg_light);
            return;
        }
        com.transsion.base.image.blurhash.e.d(com.transsion.base.image.blurhash.e.a, coverUrl, 0, 0, new Function1() { // from class: fo.g
            public final Object invoke(Object obj) {
                Unit B;
                B = h.B(view2, (BitmapDrawable) obj);
                return B;
            }
        }, 6, null);
        baseViewHolder.setText(R$id.tvAudioTitle, postSubjectItem.getTitle());
        AppCompatTextView view3 = baseViewHolder.getView(R$id.tvTime);
        ...
        if (media == null || (audio = media.getAudio()) == null) {
            ...
            Long duration = ((Audio) audio.get(0)).getDuration();
            view3.setText(TimeUtilKt.p(duration != null ? duration.longValue() : 0L));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit B(ShapeableImageView shapeableImageView, BitmapDrawable bitmapDrawable) {
    ...
    private final void C(BaseViewHolder baseViewHolder, PostSubjectItem postSubjectItem) {
        ...
        if (postSubjectItem.getSubject() != null) {
            ...
            if (viewOrNull2 != null) {
                ...
                f.b c = m.g(str).i(R.mipmap.home_ic_default_res).m(a0.a(42.0f)).c(a0.a(56.0f));
        ...
        if (viewOrNull3 != null) {
            viewOrNull3.setPageFrom("post_detail_recommend");
    ...
    public void b(BaseViewHolder baseViewHolder, PostSubjectItem postSubjectItem) {
        ...
        A(baseViewHolder, postSubjectItem);
        C(baseViewHolder, postSubjectItem);
    }
}
