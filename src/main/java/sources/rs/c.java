...
public final class c {
    ...
    public int hashCode() {
        return (((((((this.a.hashCode() * 31) + this.b) * 31) + e.a(this.c)) * 31) + e.a(this.d)) * 31) + e.a(this.e);
    }

    public String toString() {
        return "ShortTvDownloadEpisodeSelectItem(subjectId=" + this.a + ", position=" + this.b + ", isFree=" + this.c + ", isSelect=" + this.d + ", isDownload=" + this.e + ")";
    }
}
